...
(function (Games) {
    var UnitModel = /** @class */ (function () {
        ...
        Object.defineProperty(UnitModel.prototype, "currentAnimName", {
            get: function () {
                var cfg = Game.config.action.getConfig(this.currentAnimId);
                if (cfg) {
                    return cfg.action;
                }
                return this.info.idleName;
            },
            /** 设置当前动画名 */
            set: function (val) {
                this.currentAnimId = Game.config.action.getActionId(this.info.idleName);
        ...
        Object.defineProperty(UnitModel.prototype, "shrinkScaleRate", {
            get: function () {
                return this.scaleFactor / this.DEFAULT_SCALE;
            },
            enumerable: true,
            configurable: true
        });
