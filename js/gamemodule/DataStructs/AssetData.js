...
(function (Games) {
    var AssetData = /** @class */ (function () {
        ...
        AssetData.prototype.update = function (data) {
            ...
            if (data) {
                if (this.lv && this.lv < data.giveLevel) {
                    //资产等级
                    Games.Static.Instance.onUpgrdae("starAsset", this.actorId.toString(), this.lv.toString(), (data.giveLevel - this.lv).toString(), data.giveLevel.toString());
                }
