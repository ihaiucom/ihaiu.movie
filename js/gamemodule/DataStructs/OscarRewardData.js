        ...
        Object.defineProperty(OscarRewardData.prototype, "info", {
            get: function () {
                switch (this.type) {
                    ...
                    case Proto.SE.EOscarType.totalBoxOffice:
                        return Games.TEXT.OscarRewardInfoDesc_7.format((this.value4 / this.value3 * 100).toFixed(1), Game.moduleModel.street.currentStreetData.Name, this.value3);
                    case Proto.SE.EOscarType.movies:
                    case Proto.SE.EOscarType.bigSell:
                        return "";
                    default:
            ...
            get: function () {
                ...
                switch (this.type) {
                    ...
                    case Proto.SE.EOscarType.bigSell:
                        ...
                        var cfg = Game.config.global.getConfig(23);
                        if (cfg) {
                            ...
                            for (var index = 0; index < values.length; index++) {
                                ...
                                item_1.itemNum = value.v2 * this.value1;
                                items.push(item_1);
                            }
                        }
                        break;
