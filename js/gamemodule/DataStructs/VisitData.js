...
(function (Games) {
    var VisitData = /** @class */ (function () {
        ...
        VisitData.prototype.starTimeToVisit = function () {
            ...
            if (this.id > 0 && duration > 0) {
                this.visitTimeOut = setTimeout(function () {
                    var preId = _this._id;
                    Game.event.dispatch(GameEventKey.GameEventKey_UpdateVisitActor, preId);
                }, duration * 1000);
            }
        };
        //开始定时器
        ...
        Object.defineProperty(VisitData.prototype, "isActorHidden", {
            get: function () {
                var actorData = Game.moduleModel.actor.getActor(this._actorId);
                if (actorData) {
                    return actorData.hide;
                }
                return false;
            },
            enumerable: true,
