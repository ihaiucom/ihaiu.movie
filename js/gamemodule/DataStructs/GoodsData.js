...
(function (Games) {
    var GoodsData = /** @class */ (function () {
        ...
        Object.defineProperty(GoodsData.prototype, "hasBuy", {
            get: function () { return this._hasBuy; },
            set: function (num) {
                this._hasBuy = num;
            ...
            get: function () {
                ...
                switch (this.LimitType) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        str += Games.TEXT.ShopRegistLimit;
                    default:
                        return "";
                }
                return str;
        ...
        Object.defineProperty(GoodsData.prototype, "Limit", {
            get: function () {
                if (this.Config && this.Config.limit && this.Config.limit) {
                    return this.Config.limit.itemNum;
                }
                return 0;
            },
            enumerable: true,
        ...
        Object.defineProperty(GoodsData.prototype, "isAfterTime", {
            get: function () {
                if (this.Config.hasAfterTime) {
                    return this.afterTime <= 0;
                }
                return true;
            },
            enumerable: true,
        ...
        Object.defineProperty(GoodsData.prototype, "afterTime", {
            get: function () {
                return this.Config.delay - (Game.time.serverSeconds - Game.time.registerSeconds);
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(GoodsData.prototype, "afterTimeTxt", {
            get: function () {
                if (this.afterTime > 0) {
                    return Games.TimeHelper.TimeFormat(this.afterTime);
                }
                return "";
            },
            enumerable: true,
