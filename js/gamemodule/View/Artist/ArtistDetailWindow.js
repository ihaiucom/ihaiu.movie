...
(function (Games) {
    ...
    var ArtistDetailWindow = /** @class */ (function (_super) {
        ...
        function ArtistDetailWindow() {
            ...
            _this.tabstrs = [Games.TEXT.ActorTabBase, Games.TEXT.ActorTabSkill, Games.TEXT.ActorTabAsset, Games.TEXT.ActorTabExport]; //, TEXT.ActorTabAgent
            // 添加依赖资源
        ...
        ArtistDetailWindow.prototype.createTabPanel = function () {
            ...
            this.conent.m_content.addChild(this.basePanel);
            this.conent.m_content.addChild(this.skillPanel);
            this.conent.m_content.addChild(this.assetPanel);
            this.conent.m_content.addChild(this.expertPanel);
            this.conent.m_content.addChild(this.expertPanel);
            // this.basePanel.setXY(33, 510);
            // this.skillPanel.setXY(33, 510);
            // this.assetPanel.setXY(33, 510);
            // this.expertPanel.setXY(33, 510);
            this.basePanel.setXY(17, 15);
            this.skillPanel.setXY(17, 15);
            this.assetPanel.setXY(17, 15);
            this.expertPanel.setXY(17, 15);
