...
(function (Games) {
    var GuideModel = /** @class */ (function (_super) {
        ...
        function GuideModel() {
            ...
            //
            _this._guideCompleteStatus = 0;
            return _this;
        }
        Object.defineProperty(GuideModel.prototype, "guideCompleteStatus", {
            get: function () {
                return this._guideCompleteStatus;
            },
            set: function (value) {
                this._guideCompleteStatus = value;
            },
            enumerable: true,
            configurable: true
        });
        ...
        Object.defineProperty(GuideModel.prototype, "finishStoryNums", {
            //完成剧情数量
            get: function () {
                return this.finishStorys.count;
            },
            enumerable: true,
            configurable: true
        });
        ...
        //小秘书是否勾选了自动
        GuideModel.prototype.getGuideIsSecretary = function (key) {
            return Game.moduleModel.secretary.isAuto(key);
        };
        //是否设置了宣传大使
        GuideModel.prototype.getGuideIsSetPublicizeActor = function (id) {
            return Game.moduleModel.market.IsTaskPublicityActor(id);
        };
        Object.defineProperty(GuideModel.prototype, "isFinishFirst", {
            //判断是否完成过第一步引导
            get: function () {
                return this.isGuideFinished(GuideModel.firstStepId);
            },
            enumerable: true,
            configurable: true
        });
        //是否是第一个引导
        GuideModel.isFirstGuide = function (id) {
            return this.firstStepId == id;
        };
        Object.defineProperty(GuideModel.prototype, "isPopupGuideComplete", {
            //是否弹出
            get: function () {
                if (Game.moduleModel.task.getCurrentMainTask() == null && Game.moduleModel.guide.guideCompleteStatus == 0) {
                    return true;
                }
                return false;
            },
        ...
        //第一步
        GuideModel.firstStepId = 100101;
        GuideModel.initActorId = 999901;
        GuideModel.goldExchangeStepId = 105501;
        return GuideModel;
    }(Games.MModel));
