...
(function (Games) {
    ...
    var ProduceModel = /** @class */ (function (_super) {
        ...
        ProduceModel.prototype.getProcessTotalTime = function (produceId) {
            ...
            var skillOutputLevel = data.produceSkillList[Games.ProduceSkillType.Output].level;
            var extTime = Game.config.produceLevel.getConfig(skillOutputLevel).time_add;
            var skillTimeLevel = data.produceSkillList[Games.ProduceSkillType.Time].level;
