...
(function (Games) {
    var SecretaryModel = /** @class */ (function (_super) {
        ...
        function SecretaryModel() {
            ...
            _this._secretaryAutoDict = new Dictionary();
            ...
            _this.secretaryAvatarId = 9991;
            _this.curSelectKey = 0;
            // 开始刷新
            _this.isSetIntervalStart = false;
            // 申请许可证是否已刷新
            _this.isNewDayForLicense = false;
            _this.sGetLicenseUpdate = new Signal();
            return _this;
        }
        ...
        SecretaryModel.prototype.addSecretaryByProto = function (msg) {
            ...
            for (var index = 0; index < this._secretaryData.timeList.length; index++) {
                ...
                this._secretaryAutoDict.add(element.key, element.isOpen);
            }
            if (this.preMoneyReward && this.isMoneyGetReward && this.moneyRewardGot == false) {
                this.moneyRewardGot = true;
                // let giftConfig = Game.config.secretaryGift.getConfig(2001);
        ...
        SecretaryModel.prototype.secondUpdateActivity = function () {
            if (Game.time.checkNewDayToRefrush(this._secretaryData.applyLastTime, 22)) {
                // 隔天
        ...
        Object.defineProperty(SecretaryModel.prototype, "isTempSecretary", {
            //是否是临时的小秘书
            get: function () {
                if (this.isForever == false && this.secretaryData) {
        ...
        Object.defineProperty(SecretaryModel.prototype, "isMoneyGetReward", {
            //每日礼包有没有购买过
            get: function () {
                if (Games.TimeHelper.IsSameDay(this.secretaryData.lastTime, Game.time.serverSeconds) == false) {
                    return false;
                }
                else {
        ...
        Object.defineProperty(SecretaryModel.prototype, "isAutoRead", {
            ...
            set: function (value) {
                ...
                this._secretaryAutoDict.add(ESecretary.workTimes, value);
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(SecretaryModel.prototype, "isAutoActorTrain", {
            ...
            set: function (value) {
                ...
                this._secretaryAutoDict.add(ESecretary.trainTime, value);
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(SecretaryModel.prototype, "isAutoVisit", {
            ...
            set: function (value) {
                ...
                this._secretaryAutoDict.add(ESecretary.visitTimes, value);
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(SecretaryModel.prototype, "isAutoPublicize", {
            ...
            set: function (value) {
                ...
                this._secretaryAutoDict.add(ESecretary.cityTimes, value);
            },
            enumerable: true,
            configurable: true
        });
        //设置自动
        SecretaryModel.prototype.openSecretary = function (key) {
            Game.protosender.secretary.OpenSecretary(key, 1);
        };
        ...
        Object.defineProperty(SecretaryModel.prototype, "isCanGetLicense", {
            // 是否存在可领取的许可证
            get: function () {
                var can = false;
                if (this.secretaryData.isApply) {
                    var overTime = Game.config.secretary.getConfig(11).par - Game.time.getSubSecondsPre(this.secretaryData.applyLastTime);
                    if (overTime <= 0) {
                        can = true;
                    }
                }
        ...
        Object.defineProperty(SecretaryModel.prototype, "dailyGift", {
            //每日特供礼包
            get: function () {
                return this.dailyGiftCfg.rechangeGifts;
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(SecretaryModel.prototype, "dailyGiftCfg", {
            get: function () {
                return Game.config.recharge.getConfig(1009);
            },
            enumerable: true,
            configurable: true
        });
        SecretaryModel.prototype.isAuto = function (key) {
            return this._secretaryAutoDict.getValue(key);
        };
