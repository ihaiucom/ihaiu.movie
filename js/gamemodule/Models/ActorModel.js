...
(function (Games) {
    var ActorModel = /** @class */ (function (_super) {
        ...
        ActorModel.prototype.setup = function () {
            ...
            var resetDayTime = User.info.resetDaysCultivateCountTime;
            if (Game.time.checkNewDayToRefrush(resetDayTime, 0)) {
                User.info.daysCultivateCount = 0;
            }
            else {
                var time = resetDayTime - currSecond;
        ...
        Object.defineProperty(ActorModel.prototype, "isOpenTrain", {
            //是否开放培养
            get: function () {
                var id = GlobalConfig.getValue(GlobalKey.KEY_1032_YiRenPeiYang__ChengShiID);
                return Game.moduleModel.market.GetCityState(id) == Games.CityStateEnum.hasOccupy;
            },
            enumerable: true,
            configurable: true
        });
        ...
        Object.defineProperty(ActorModel.prototype, "openTrainTip", {
            ...
            get: function () {
                var id = GlobalConfig.getValue(GlobalKey.KEY_1032_YiRenPeiYang__ChengShiID);
                var city = Game.config.city.getConfig(id);
                var tip;
                if (city) {
                    tip = format(Games.TEXT.TrainOpen, city.name);
                }
                return tip;
            },
            enumerable: true,
