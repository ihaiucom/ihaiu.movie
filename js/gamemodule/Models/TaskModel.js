...
(function (Games) {
    var TaskModel = /** @class */ (function (_super) {
        ...
        function TaskModel() {
            ...
            _this.mainGoal = new Games.GoalData();
        ...
        //所有主线任务
        TaskModel.prototype.getMainTaskList = function () {
            return this.getTaskListByType(EAchievementType.mainTask);
        };
        /**
         * 移除
         * @param uuid 服务器唯一id
        ...
        TaskModel.prototype.removeTaskDataByUUid = function (uuid) {
            ...
            if (data) {
                ...
                if (data.isMainTask && data.mainConfig) {
                    ...
                    if (GlobalConfig.getValue(GlobalKey.maintask_complete_end) == data.id) {
                        // apps引导结束
                        Games.Static.Instance.onFinishTutorial(data.id);
                    }
                }
        ...
        TaskModel.prototype.checkFinishGuide = function (data) {
            if (data.isFinished) {
                Game.guide.endGuide(false);
            }
        };
        // /**
        //  * 外部更新客户端进度更新
         ...
         * 客户端获取任命形象大使
         */
        TaskModel.prototype.clientChooseFoucePointCityProgress = function () {
            var progress = 0;
            var list = Game.moduleModel.warData.movieDataList;
            if (list && list.length > 0) {
                for (var index = 0; index < list.length; index++) {
                    var element = list[index];
                    if (element.extendCity > 0) {
                        progress = 1;
                        break;
                    }
                }
        ...
        Object.defineProperty(TaskModel.prototype, "allMainTaskCount", {
            //主线任务总数
            get: function () {
                return Game.config.maintask.getConfigList().length;
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(TaskModel.prototype, "remainMainTaskCount", {
            //主线任务剩余总数
            get: function () {
                var list = this.getMainTaskList();
                var len = 0;
                if (list) {
                    len = list.length;
                }
        ...
        Object.defineProperty(TaskModel.prototype, "guideCompleteRewardID", {
            //新手任务奖励
            get: function () {
                return GlobalConfig.getValue(GlobalKey.maintask_complete_reward);
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(TaskModel.prototype, "mainTaskProgressGoal", {
            get: function () {
                this.mainGoal.initData((this.allMainTaskCount - this.remainMainTaskCount), this.allMainTaskCount);
        ...
        //是否完成
        TaskModel.prototype.isCompleteMainTask = function (id) {
            var task = this.taskDict.getValue(id);
            if (task) {
                return false;
            }
            return true;
