...
(function (Games) {
    ...
    var CooperationModel = /** @class */ (function (_super) {
        ...
        function CooperationModel() {
            ...
            _this.sSetDealyCanUseSignal = new Signal();
            ...
            // 更新宝箱进度
            _this.sUpdateBoxProgress = new TypedSignal();
        ...
        Object.defineProperty(CooperationModel.prototype, "isCanGetReward", {
            // 能否领取进度宝箱	跨天判断	
            get: function () {
                if (Game.time.checkNewDayToRefrush(this.cooperPlayerData.lastTime, 0)) {
                    return true;
                }
                return false;
            },
        ...
        CooperationModel.prototype.updateCooperateTaskData = function (msg, ops, uuid) {
            ...
            if (ops === EGameDataOps.remove) {
                ...
                this.isRewardBoxRedTip = false;
                for (var i = 1; i < 7; i++) {
                    var status_1 = (this.cooperPlayerData.rewardStatus >> i) & 1;
        ...
        CooperationModel.prototype.setDealyCanUse = function () {
            var _this = this;
            if (this.btnDelayTime <= 0) {
                this.btnDelayTime = this.inviteCD * 1000;
                setTimeout(function () {
                    _this.btnDelayTime = 0;
                    _this.sSetDealyCanUseSignal.dispatch();
                }, this.inviteCD * 1000);
                return true;
            }
            return false;
