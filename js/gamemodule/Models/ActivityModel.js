...
(function (Games) {
    ...
    var ActivityModel = /** @class */ (function (_super) {
        ...
        ActivityModel.prototype.sendSign = function () {
            this.sendSignDayCount = this.curSignDay;
            Game.protosender.dailySign.sign();
        };
        // 签到服务器返回
        ActivityModel.prototype.handlerSign = function (msg) {
            Games.Static.Instance.onUserorbit("day", "第" + this.sendSignDayCount + "天", "sign");
        ...
        ActivityModel.prototype.handlerSevenGet = function (msg) {
            ...
            var sevenConfig = Game.moduleModel.activity.sevenConfig;
            Games.Static.Instance.onUserorbit("award7", format("第{0}天&{1}", this.sevenGearNum, sevenConfig[this.curGear].reward[0].itemId), "get");
