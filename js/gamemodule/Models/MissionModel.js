    ...
    var MissionModel = /** @class */ (function (_super) {
        ...
        MissionModel.prototype.getUnlockList = function () {
            ...
            for (var i = 0; i < this.list.length; i++) {
                ...
                var unlock = Game.moduleModel.building.validataBuildLevel(data.config.unlock);
                if (unlock) {
                    list.push(data);
                }
                // list.push(data);
            ...
            list.sort(function (a, b) {
                ...
                if (stateB == stateA) {
                    if (a.config.goal > 0 && b.config.goal > 0) {
                        return b.protoData.progress / b.config.goal - a.protoData.progress / a.config.goal;
                    }
                }
