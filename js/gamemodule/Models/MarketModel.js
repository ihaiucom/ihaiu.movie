...
(function (Games) {
    ...
    var MarketModel = /** @class */ (function (_super) {
        ...
        MarketModel.prototype.UpdateCityData = function (msg) {
            this.info = msg;
            this.info.lastAreaProgress = Math.floor(this.info.lastAreaProgress / 100);
        };
        ...
        MarketModel.prototype.GetCityProgress = function () {
            ...
            while (id != 0) {
                ...
                occupyNum = occupyNum + cfg.city_schedule;
                id = cfg.pre_id;
            }
            if (occupyNum >= 99) {
                occupyNum = 100;
        ...
        MarketModel.prototype.GetNextUnlockCountryId = function (id) {
            var cfg = Game.config.country.getConfig(id);
            if (cfg) {
                var next = cfg.next_country;
                if (next != 0) {
                    var lastId = this.GetLastCountryId();
                    if (Game.config.country.sort(lastId, next) >= 0) {
                        return next;
                    }
                }
            }
        ...
        MarketModel.prototype.GetPreUnlockCountryId = function (id) {
            var cfg = Game.config.country.getConfig(id);
            if (cfg) {
                var pre_1 = cfg.pre_id;
                if (pre_1 != 0) {
                    var lastId = this.GetLastCountryId();
                    if (Game.config.country.sort(lastId, pre_1) >= 0) {
                        return pre_1;
                    }
                }
            }
        ...
        MarketModel.prototype.GetCountryList = function () {
            ...
            return CountryList.sort(function (a, b) { return a.id - b.id; });
        };
        ...
        MarketModel.prototype.GetPreCityList = function (cityData, num) {
            if (cityData == null || cityData.cfg == null) {
                return [];
            }
            var list = [];
        ...
        Object.defineProperty(MarketModel.prototype, "RedNum", {
            get: function () {
                ...
                var goldLimit = this.GoldLimit;
                if (curGold <= 0) {
                    return false;
                }
                return curGold > goldLimit;
            },
            enumerable: true,
            configurable: true
        });
        ...
        */
         ...
         * @param id 街道ID
         */
        MarketModel.prototype.IsTaskPublicityActor = function (id) {
            if (id == this.Info.lastArea) {
                return this.Info.propagandaActor > 0;
            }
            return false;
        };
        return MarketModel;
