...
(function (Games) {
    ...
    var RankModel = /** @class */ (function (_super) {
        ...
        Object.defineProperty(RankModel.prototype, "RankRewardList", {
            get: function () {
                return Games.TimeHelper.IsWeek(Game.time.serverSeconds, 0) ? Game.config.serverRankingList.weekRewardList : Game.config.serverRankingList.dailyRewardList;
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(RankModel.prototype, "LastRewardList", {
            get: function () {
                ...
                var isWeek7 = Games.TimeHelper.IsWeek(Game.time.serverSeconds + 2 * 60 * 60, 1);
                var rank = isWeek7 ? this.rankInfo.lastWeakRank : this.rankInfo.lastRank;
                return Game.config.serverRankingList.GetRewards(this.rankInfo.lastRank, isWeek7);
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(RankModel.prototype, "RedNum", {
            get: function () {
                return this.CanGetReward && !this.hasGetLastReward;
            },
            enumerable: true,
            configurable: true
        });
