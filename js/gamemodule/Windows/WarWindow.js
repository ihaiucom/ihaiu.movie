...
(function (Games) {
    ...
    var WarWindow = /** @class */ (function (_super) {
        ...
        // 菜单显示
        WarWindow.prototype.menuShow = function (root) {
            this.showOn(root);
        };
        //=========================
        // 显示完成
        ...
        Object.defineProperty(WarWindow.prototype, "selectSecondFilm", {
            get: function () {
                if (this.conent && this.warFilmSelectingSubwindow.conent.m_filmItemList.numItems > 2) {
        ...
        Object.defineProperty(WarWindow.prototype, "selectActorOkBtn", {
            get: function () {
                if (this.conent && this.selectyirenSubwindow.conent.m_okBtnContorl.selectedIndex === 1) {
