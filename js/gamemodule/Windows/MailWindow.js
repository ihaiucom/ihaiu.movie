...
(function (Games) {
    ...
    var MailWindow = /** @class */ (function (_super) {
        ...
        function MailWindow() {
            ...
            _this.mailContentSubwindow = new Games.MailContentSubwindow("mailContent", _this);
            _this.registerSubwindow(_this.mailContentSubwindow);
            // 添加依赖资源
            _this.addAssetForFguiComponent(fgui.PfSkin.MailMainPanel);
            return _this;
        }
        // 菜单创建
        MailWindow.prototype.onMenuCreate = function () {
            this.conent = fgui.PfSkin.MailMainPanel.createInstance();
    ...
    Games.MailWindow = MailWindow;
})(Games || (Games = {}));
//# sourceMappingURL=MailWindow.js.map