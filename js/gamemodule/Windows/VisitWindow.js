...
(function (Games) {
    ...
    // 模版窗口, 没有用到的方法尽量删掉
    //----------------------
    var VisitWindow = /** @class */ (function (_super) {
        __extends(VisitWindow, _super);
        function VisitWindow() {
            ...
            // 添加依赖资源
            _this.addAssetForFguiComponent(fgui.Manage.VisitUI);
            return _this;
        }
        // 生成动态预加载资源
        VisitWindow.prototype.generateAssetsForDynmic = function () {
        ...
        // 菜单创建
        VisitWindow.prototype.onMenuCreate = function () {
            this.conent = fgui.Manage.VisitUI.createInstance();
        ...
        // 可以在这里添加协议消息监听
        //-------------------------
        VisitWindow.prototype.onShowComplete = function () {
        ...
        // 可以在这里移除协议消息监听
        //-------------------------
        VisitWindow.prototype.onHideComplete = function () {
            _super.prototype.onHideComplete.call(this);
        };
        return VisitWindow;
    }(Games.MWindow));
    Games.VisitWindow = VisitWindow;
})(Games || (Games = {}));
//# sourceMappingURL=VisitWindow.js.map