    ...
    (function (Market) {
        var MarketRoadShowPanel = /** @class */ (function (_super) {
            ...
            MarketRoadShowPanel.prototype.onWindowShow = function () {
                ...
                this.m_fxAixin.visible = false;
                this.m_btnSkip.visible = false;
                this.OpenView();
            };
            ...
            MarketRoadShowPanel.prototype.OpenView = function () {
                ...
                this.m_listActor.scrollToView(this.m_listActor.numItems - 1);
            ...
            MarketRoadShowPanel.prototype.StartAnim = function () {
                ...
                Game.stageManager.roadshow.isActive = true;
                this.roadShowAnimPanel = Game.stageManager.roadshow.mainScene.mainView;
                this.roadShowAnimPanel.showFor(this.m_roadshowContainer, this);
                setTimeout(function () {
                    _this.m_fxAixin.visible = true;
                    _this.m_btnSkip.visible = true;
                }, 10000);
            };
