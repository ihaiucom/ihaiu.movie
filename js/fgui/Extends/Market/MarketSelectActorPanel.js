    ...
    (function (Market) {
        var MarketSelectActorPanel = /** @class */ (function (_super) {
            ...
            MarketSelectActorPanel.prototype.UpdateList = function () {
                var _this = this;
                this.actorList = Game.moduleModel.market.GetActorList().concat().sort(function (a, b) {
            ...
            MarketSelectActorPanel.prototype.OnSelect = function (obj) {
                ...
                if (item.onselect()) {
                    var rect = item.localToGlobalRect(item.m_icon.x + item.m_icon.width / 2, item.m_icon.y, item.m_icon.width + item.m_icon.height / 2, item.m_icon.height);
