    ...
    (function (Market) {
        var MarketPublicityPanel = /** @class */ (function (_super) {
            ...
            MarketPublicityPanel.prototype.UpdateView = function () {
                ...
                this.m_btnPublicity.m_cost.text = formatNumberUnit(this.pointData.cfg.publicize_cost);
                this.m_btnPublicity.m_assetLoader.url = Game.config.item.getItemIcon(3);
            ...
            MarketPublicityPanel.prototype.OnTabSelfmotionChangState = function () {
                if (Game.guide.isGuideUI(this.m_tabSelfmotion)) {
            ...
            MarketPublicityPanel.prototype.OnBtnAddActorClick = function () {
                ...
                mainWindow.openSubwindowByIndex(Games.MarketSubEnum.SelectActor, false, function (actor, tweenRect) {
            ...
            MarketPublicityPanel.prototype.OnsPropaganda = function (msg) {
                if (Game.moduleModel.market.Info.lastArea == this.pointData.id && Game.moduleModel.market.Info.lastAreaProgress < 100) {
                    ...
                    Games.Static.Instance.onUserorbit("market", User.info.stall + "&" + this.pointData.city + "&" + this.pointData.id, "publicity");
                }
            ...
            MarketPublicityPanel.prototype.OnPublicityTransFinish = function () {
                var _this = this;
                Game.system.getRewardText(this.publicRewards, Games.TEXT.MarketReward, this.m_tabSelfmotion.selected ? 0.3 : 0);
                // Game.system.getRewardText(this.publicRewards, Games.TEXT.MarketReward, 0.3);
                if (Game.moduleModel.market.Info.lastArea != this.pointData.id || Game.moduleModel.market.Info.lastAreaProgress == 100) {
                    this.ShowFinishView();
                    this.UnlockButton();
                }
                    ...
                    if (this.m_tabSelfmotion.selected) {
                        // setTimeout(Handler.create(this, this.PublicityOnce), 300);
                        setTimeout(function () { _this.PublicityOnce(); }, 500);
                    }
                    else {
                        this.UnlockButton();
            ...
            MarketPublicityPanel.prototype.LockButton = function () {
                this.m_btnAddActor.enabled = false;
                this.m_btnPublicity.enabled = false;
                this.m_tabSelfmotion.enabled = false;
            };
            MarketPublicityPanel.prototype.UnlockButton = function () {
                this.m_btnAddActor.enabled = true;
                this.m_btnPublicity.enabled = true;
                this.m_tabSelfmotion.enabled = true;
            };
            ...
            MarketPublicityPanel.prototype.OnPublicityFinish = function () {
                ...
                Game.story.triggerPlayStoryByType(Games.StoryTriggerType.FinishStreet);
                // let mainWindow = <Games.MarketWindow>(this.moduleWindow.mainWindow);
