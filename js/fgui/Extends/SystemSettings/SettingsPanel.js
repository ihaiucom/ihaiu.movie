    ...
    (function (SystemSettings) {
        var SettingsPanel = /** @class */ (function (_super) {
            ...
            SettingsPanel.prototype.constructFromXML = function (xml) {
                ...
                this.m_FeedBackBtn.visible = false;
            };
            // 关闭
            ...
            SettingsPanel.prototype.onRefrush = function () {
                ...
                this.m_version.text = format(Game.config.msg.getConfig(MsgKey.version_num).notice, GameVersions.Manager.Instance.localAppVersionData.toString());
