    ...
    (function (WarMovie) {
        var WarFilmJiesuan = /** @class */ (function (_super) {
            ...
            WarFilmJiesuan.prototype.initYRListItem = function (index, obj) {
                var item = obj;
                item.ActorId = Game.moduleModel.warData.getRealYRList.getValue(index).id;
            ...
            WarFilmJiesuan.prototype.porgressOver = function () {
                ...
                this.m_t0.play(laya.utils.Handler.create(this, function () {
                    ...
                    if (mainTask && mainTask.isFinished) {
                        Game.story.triggerPlayStoryByType(Games.StoryTriggerType.FristMovieUp, mainTask.id);
                    }
                    _this.m_fx.m_t0.play(Handler.create(_this, function () { _this.m_fx.visible = false; }), 1);
                    // this.m_fx.m_pro_drop.m_t1.play(null, 1);
                    // this.m_fx.m_effect_pro002.m_t88999.play(null, 1);
                    _this.canClose = true;
                }), 1);
