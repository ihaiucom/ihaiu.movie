    ...
    (function (WarMovie) {
        var FilmSelectItem = /** @class */ (function (_super) {
            ...
            FilmSelectItem.prototype.onClickSelectBtn = function () {
                var _this = this;
                if (FilmSelectItem.isSelectStory) {
                    return;
                }
                ...
                if (myHaveDollar >= this.cost) {
                    ...
                    Game.system.openRename(Games.TEXT.ChangeStoryName, null, function (txt) {
                        // this.moduleWindow.warFilmSelectingSubwindow.closeSelf();
                        FilmSelectItem.isSelectStory = true;
                        _this.moduleWindow.conent.startShowWaiting();
                        Game.moduleModel.warData.SendReName(txt, _this.currData);
            ...
            FilmSelectItem.prototype.setData = function (data, index, isHaveGuanzhong) {
                ...
                this.m_selectBtn.m_item.icon = Game.config.avatar.getConfig(Game.config.item.getConfig(EItemId.dollar).icon).iconUrl;
                if (isHaveGuanzhong) {
                    // 观众需求
            ...
            FilmSelectItem.isSelectStory = false;
