...
(function (fgui) {
    ...
    (function (PfSkin) {
        var RechargeMainPanel = /** @class */ (function (_super) {
            ...
            RechargeMainPanel.prototype.onWindowDestory = function () {
            ...
            RechargeMainPanel.prototype.onWindowShow = function () {
                Game.protoOkEvent.add(ProtoEventKey.SecretaryData, this.UpdateView, this);
            ...
            RechargeMainPanel.prototype.onWindowHide = function () {
                Game.protoOkEvent.remove(ProtoEventKey.SecretaryData, this.UpdateView, this);
