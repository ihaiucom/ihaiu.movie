    ...
    (function (PfSkin) {
        var ArtistTrainItem2 = /** @class */ (function (_super) {
            ...
            ArtistTrainItem2.prototype.updateView = function (data, index, isMax) {
                ...
                this.m_upgradeBtn.m_gold.text = formatNumberUnit(data.upgradeTrainCostGoldNum(this.type)) + "";
            ...
            ArtistTrainItem2.prototype.checkItemEnough = function () {
                if (this.isMax) {
                    var enough = Games.ItemHelper.checkItemEnough(this.trainData.diamondsCost);
                    if (enough) {
                        this.upgrade();
                    }
                    else {
                        Game.system.openItemWay(this.trainData.diamondsCost.itemId, this.trainData.diamondsCost.itemNum);
                    }
                }
                else {
                    this.upgrade();
            ...
            ArtistTrainItem2.prototype.upgrade = function () {
                ...
                if (enough) {
                    ...
                    Games.Static.Instance.onUserorbit("star", this.actorData.id.toString(), "foster");
                    Games.Static.Instance.onUseGold("starFoster", this.trainData.diamondsCost.itemNum, "");
                }
                else {
