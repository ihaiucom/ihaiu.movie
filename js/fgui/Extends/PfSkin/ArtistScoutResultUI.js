...
(function (fgui) {
    ...
    (function (PfSkin) {
        var ArtistScoutResultUI = /** @class */ (function (_super) {
            ...
            ArtistScoutResultUI.prototype.onWindowShow = function () {
                this.isPlayed = false;
                this.updateView();
            };
            /**
                ...
                if (Game.moduleModel.actor.actorIsMax) {
                    ...
                    if (Game.moduleModel.actor.isMaxNose) {
                        Game.system.openGoOtherFunc(Games.OtherFunctionType.ActorStarCard, Games.TEXT.TitleTip, TEXT.SystemGoOtherFunction_Desc_2, function () {
                            Game.moduleModel.actor.normalNoseActor(true);
                        });
                    }
                    else {
                        //请求探查艺人
            ...
            ArtistScoutResultUI.prototype.playEffect = function () {
                var _this = this;
            ...
            ArtistScoutResultUI.prototype.updateView = function () {
                ...
                this.m_xingtan.text = formatNumberUnit(Game.moduleModel.item.getItemNum(EItemId.talent));
                this.startTime();
            };
            /**
             * 更新单条数据
