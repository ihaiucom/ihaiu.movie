    ...
    (function (Activity) {
        var SecretaryPanel = /** @class */ (function (_super) {
            ...
            SecretaryPanel.prototype.onClickDailyBtn = function () {
                var dailyConfig = Game.config.secretaryGift.getConfig(2001);
                if (this.secretaryData.secretaryType == ESecretaryType.had) {
                    ...
                    if (Game.moduleModel.secretary.isMoneyGetReward) {
                        //已经领取
                        Game.system.openAwardsGift(dailyConfig.items, TEXT.Secretary_DailyGiftTitle, Game.config.msg.getTxt(MsgKey.secretary_bought), TEXT.Buyed, false);
                    }
                    else {
                        //可以领取
                        //需要购买
                        Game.system.openAwardsGift(dailyConfig.items, TEXT.Secretary_DailyGiftTitle, TEXT.Secretary_GetRewardDailySecretary, "$1", true, function () {
                            //需要购买
                    ...
                    //没有拥有需要购买
                    Game.system.openAwardsGift(dailyConfig.items, TEXT.Secretary_DailyGiftTitle, TEXT.Secretary_NeedBuySecretary, "$1", true, function () {
                        //需要购买
            ...
            SecretaryPanel.prototype.setData = function () {
                ...
                if (secretaryData) {
                    ...
                    //随机对话
                    this.m_talkMsg.text = Game.config.msg.getTxt(Math.random() > 0.5 ? MsgKey.secretary_talk1 : MsgKey.secretary_talk2);
                    //小秘书
