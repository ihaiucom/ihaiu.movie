...
(function (fgui) {
    ...
    (function (Activity) {
        var LicenseReq = /** @class */ (function (_super) {
            ...
            LicenseReq.prototype.delayShowFx = function () {
                var _this = this;
                this.m_fxCt.setSelectedIndex(1);
                if (this.m_fxBase && this.m_fxBase.m_t0) {
                    this.m_fxBase.m_t0.play(Handler.create(this, function () {
                        if (_this.m_fx && _this.m_fx.m_t5555555) {
                            _this.m_fx.m_t5555555.play(Handler.create(_this, function () {
                                _this.m_fxCt.setSelectedIndex(0);
                            }), 1);
                        }
                    }), 1);
                }
            ...
            LicenseReq.prototype.setData = function (activityMain) {
                var _this = this;
                if (this.m_fxCt.selectedIndex !== 0) {
                    this.m_fxCt.setSelectedIndex(0);
                }
                Game.moduleModel.secretary.secondUpdateActivity();
                if (this.updateNum > 0) {
