...
(function (fgui) {
    ...
    (function (ArtistDetail) {
            ...
            ArtistSkillItem.prototype.onClickUpgradeBtn = function () {
                if (this.isHasNextLv) {
                    if (this.actorData.skillExp >= this.config.exp) {
                        ...
                        Games.Static.Instance.onUserorbit("star", this.actorData.id + "&" + this.config.id, "skill");
                    }
                    else {
        ...
        }(ArtistDetail.ArtistSkillItemStruct));
        ArtistDetail.ArtistSkillItem = ArtistSkillItem;
