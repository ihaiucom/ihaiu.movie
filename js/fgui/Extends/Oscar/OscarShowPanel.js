    ...
    (function (Oscar) {
        var OscarShowPanel = /** @class */ (function (_super) {
            ...
            OscarShowPanel.prototype.onWindowOpen = function (arg) {
                ...
                this.m_input.text = "Enter a barrage";
            ...
            OscarShowPanel.prototype.StartOscar = function () {
                var _this = this;
                //
                Game.guide.checkOpenOscarWindow(1, function () {
                    _this.currentAwards = -1;
                    _this.NextPrize();
                });
            };
            ...
            OscarShowPanel.prototype.OnPrizeSelect = function () {
                this.m_listCandidate.resizeToFit();
            ...
            OscarShowPanel.prototype.OnPrize = function () {
                ...
                var targetItem = this.m_showWinner.m_candidate;
                this.m_winnerItem.visible = true;
                this.m_winnerItem.setXY(targetItem.x, targetItem.y);
                this.m_winnerItem.setScale(targetItem.scaleX, targetItem.scaleY);
                this.m_showWinner.Hide();
                Laya.Tween.to(this.m_winnerItem, { x: this.m_showPoint.x, y: this.m_showPoint.y, scaleX: 1.2, scaleY: 1.2 }, this.delayCandidateShow);
            ...
            OscarShowPanel.prototype.onWindowShow = function () {
                Game.sound.playMusic(SoundKey.MM_BGM_RoadShow);
                this.m_danmu.Show();
            ...
            OscarShowPanel.prototype.showOscarReward = function () {
                ...
                Game.guide.checkOpenOscarWindow(2, null);
                this.moduleWindow.mainWindow.openSubwindowByIndex(Games.OscarSubEnum.OscarReward, true);
            };
