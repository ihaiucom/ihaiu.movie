...
(function (fgui) {
    ...
    (function (Oscar) {
        var OscarShowFrontView = /** @class */ (function (_super) {
            ...
            OscarShowFrontView.prototype.UpdateListSelect = function () {
                this.m_listOscarCup.selectedIndex = this.selectIndex;
                for (var index = 0; index < this.m_listOscarCup.numChildren; index++) {
                    var item = this.m_listOscarCup.getChildAt(index);
                    item.enabled = this.currentIndex >= index;
                }
            };
