    ...
    (function (Building) {
        ...
        var BuildRoomUpgrade = /** @class */ (function (_super) {
            ...
            BuildRoomUpgrade.prototype.onServerRoomUpgrade = function (msg) {
                ...
                Games.Static.Instance.onUserorbit("building", roomInfo.floor + "&" + msg.roomId, "upgrade");
            };
            ...
            BuildRoomUpgrade.prototype.loadRoomPart = function () {
                if (!this.info)
                    return;
                switch (this.info.type) {
                    case Games.RoomType.Cinema:
                        this.roomPart = fgui.Building.BuildScene1.createInstance();
                        break;
                }
                if (this.roomPart) {
                    this.m_scenePart.addChild(this.roomPart);
                }
            };
            BuildRoomUpgrade.prototype.removeRoomPart = function () {
                if (this.roomPart) {
                    this.roomPart.removeFromParent();
                    this.roomPart.dispose();
                    this.roomPart = null;
                }
            };
            //----------------------------
            ...
            BuildRoomUpgrade.prototype.onUpgradeSuccess = function () {
                ...
                //aspect
                buildRoomUpgradeSuccess.setSize(fairygui.GRoot.inst.width, fairygui.GRoot.inst.height);
                buildRoomUpgradeSuccess.addRelation(Games.MenuLayer.module, fairygui.RelationType.Size);
                this.onClose();
            };
