...
(function (fgui) {
    ...
    (function (MainUI) {
        var GuideTaskDialog = /** @class */ (function (_super) {
            ...
            GuideTaskDialog.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
                this.m_roleGetReward.icon = Game.config.avatar.getConfig(9991).bodyIconUrl;
                this.m_role.icon = Game.config.avatar.getConfig(9991).bodyIconUrl;
            };
