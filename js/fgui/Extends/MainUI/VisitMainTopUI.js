            ...
            VisitMainTopUI.prototype.show = function (data) {
                if (data.actorId > 0) {
                    ...
                    if (this.avatar == null) {
                        ...
                        this.avatar.pos((this.width) * 0.5, bounds.height + 80);
                        this.avatar.showOn(this);
                        this.avatar.direction = Games.DirtionType.Left;
                        ...
                        this.avatar.on(Laya.Event.CLICK, this, this.onClickIcon);
                        //avatar.setTalk(TEXT.ActorExperciser, true);
                        this.avatar.openShadow();
                        // this.avatar = Games.Avatar.Creat(aInfo, (AvatarInfo) =>
                        // {
