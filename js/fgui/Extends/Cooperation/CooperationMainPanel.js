    ...
    (function (Cooperation) {
        var CooperationMainPanel = /** @class */ (function (_super) {
            ...
            CooperationMainPanel.prototype.constructFromXML = function (xml) {
                ...
                this.m_otherID.input.restrict = "0-9";
                // 关闭面板
            ...
            CooperationMainPanel.prototype.onClickPublicBtn = function () {
                if (Game.moduleModel.cooperation.cooperData.weekTimes < Game.config.global.getConfig(GlobalKey.KEY_29_MeiZhouGeZuoCiShu).value) {
                    ...
                    if (Game.moduleModel.cooperation.setDealyCanUse()) {
                        Game.moduleModel.cooperation.sendApply(0);
                    }
                    else {
                        Game.system.toastText(Game.config.msgProtoError.getConfig(5502).notice);
                    }
                }
                else {
            ...
            CooperationMainPanel.prototype.setUseCan = function () {
                this.m_inviteBtn2.grayed = false;
            };
            // 搜索指定id的合作者
            ...
            CooperationMainPanel.prototype.onWindowShow = function () {
                ...
                Game.moduleModel.cooperation.sSetDealyCanUseSignal.add(this.setUseCan, this);
            ...
            CooperationMainPanel.prototype.onWindowHide = function () {
                ...
                Game.moduleModel.cooperation.sSetDealyCanUseSignal.remove(this.setUseCan, this);
            ...
            CooperationMainPanel.prototype.setData = function () {
                this.m_otherID.text = "";
                if (!Game.moduleModel.cooperation.cooperPlayerData || Game.moduleModel.cooperation.cooperPlayerData === null || !Game.moduleModel.cooperation.cooperData || Game.moduleModel.cooperation.cooperData === null) {
                    Game.system.toastText("no data !!!");
                    this.moduleWindow.menuBack();
                }
                else {
                    this.checkTime();
