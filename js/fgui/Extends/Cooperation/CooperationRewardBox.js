        ...
        var CooperationRewardBox = /** @class */ (function (_super) {
            ...
            CooperationRewardBox.prototype.setData = function (msg, index) {
                ...
                if (this.rewardList.length > 1) {
                    this.m_listBg.width = this.rewardList.length * 70 + 10;
                }
                else {
                ...
                this.status = (Game.moduleModel.cooperation.cooperPlayerData.rewardStatus >> index) & 1;
                if (Game.moduleModel.cooperation.isCanGetReward) {
                    this.status = 0;
                }
                ...
                Game.moduleModel.cooperation.sUpdateBoxProgress.dispatch(arg);
            };
