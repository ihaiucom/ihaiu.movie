    ...
    (function (Common) {
        var MovieInfoItem = /** @class */ (function (_super) {
            ...
            MovieInfoItem.prototype.Render = function (movieData, block) {
                ...
                if (this.movieData && this.movieData.boxOfficeEvaluation != null) {
                    var sellIcon = Game.config.movieDrop.getSellIcon(this.movieData.boxOfficeEvaluation);
                    this.m_icon.m_lv.icon = Game.config.avatar.GetIconUrl(sellIcon);
                }
                this.m_icon.m_lv.title = "";
                // this.m_icon.m_star.starNum = Game.config.story.GetStar(this.movieData.movieId);
                this.m_icon.m_starList.numItems = Game.config.story.GetStar(this.movieData.movieId);
            };
