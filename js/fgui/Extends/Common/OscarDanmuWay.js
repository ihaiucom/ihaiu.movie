    ...
    (function (Common) {
        var OscarDanmuWay = /** @class */ (function (_super) {
            ...
            function OscarDanmuWay() {
                ...
                _this.contentCache = [];
                _this.isStart = false;
                _this.isFinishLoop = false;
                return _this;
            }
            Object.defineProperty(OscarDanmuWay.prototype, "IsFinishLoop", {
                set: function (value) {
                    this.isFinishLoop = value;
                },
                enumerable: true,
                configurable: true
            });
            ...
            OscarDanmuWay.prototype.OnMoveFree = function (item) {
                if (!this.isFinishLoop) {
                    this.NextDanmu();
                }
            };
            OscarDanmuWay.prototype.NextDanmu = function () {
