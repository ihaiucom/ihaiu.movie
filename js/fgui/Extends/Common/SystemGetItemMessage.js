    ...
    (function (Common) {
        var SystemGetItemMessage = /** @class */ (function (_super) {
            ...
            SystemGetItemMessage.prototype.open = function (itemList, closeFun, isAutoClose, closeButtonVisiable, buttonEnable, isClickButtonAutoClose) {
                ...
                this.m_Group.m_listItem.itemRenderer = new Handler(this, this.RenderItem, null, false);
            ...
            SystemGetItemMessage.prototype.UpdateRewardList = function () {
                this.m_Group.m_listItem.numItems = Math.min(this.MaxShowNum, this.items.length - this.showIndex);
            };
            ...
            SystemGetItemMessage.prototype.triggerCloseFunc = function () {
                if (this.closeFun) {
                    this.closeFun();
                    this.closeFun = null;
                }
