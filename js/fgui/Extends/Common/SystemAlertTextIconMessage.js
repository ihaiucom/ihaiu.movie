...
(function (fgui) {
    ...
    (function (Common) {
        var SystemAlertTextIconMessage = /** @class */ (function (_super) {
            ...
            SystemAlertTextIconMessage.prototype.addScreenRestSizeListen = function () {
            ...
            SystemAlertTextIconMessage.prototype.removeScreenRestSizeListen = function () {
                this.isAddScreenRestSizeListen = false;
                Laya.stage.off(laya.events.Event.RESIZE, this, this.setScreenSize);
            };
            SystemAlertTextIconMessage.prototype.setScreenSize = function () {
                centerScreen(this);
