        ...
        var VisitUI = /** @class */ (function (_super) {
            ...
            VisitUI.prototype.updateView = function () {
                ...
                if (visitData) {
                    ...
                    ;
                    if (visitData.actorId > 0 && visitData.isWaiting) {
                        this.m_dialog.visible = true;
                        //见艺人
                        this.m_dialog.m_title.text = Games.TEXT.VisitFansTomeetActor;
                        var actorData = Game.moduleModel.actor.getActor(visitData.actorId);
                        if (actorData) {
                            this.m_dialog.m_name.text = actorData.name;
                        }
                    }
                    else {
                        this.m_dialog.visible = false;
                    ...
                    //
                    this.m_icon.icon = Game.config.avatar.getConfig(Game.moduleModel.secretary.secretaryAvatarId).bodyIconUrl;
                }
            };
