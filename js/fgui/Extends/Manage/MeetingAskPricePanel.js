    ...
    (function (Manage) {
        var MeetingAskPricePanel = /** @class */ (function (_super) {
            ...
            MeetingAskPricePanel.prototype.constructFromXML = function (xml) {
                ...
                this.m_remainTimesTitle.text = Game.config.msg.getTxt(MsgKey.left_times);
            ...
            MeetingAskPricePanel.prototype.onClickRefuseBtn = function () {
                ...
                if (data) {
                    Games.Static.Instance.onUserorbit("meeting", data.pireceIntoDaDianForMaidian(0), "end");
                }
                Game.protosender.manageMeeting.GetReward(MeetingRewardType.Refuse);
            };
            MeetingAskPricePanel.prototype.onClickOkBtn = function () {
                var _this = this;
                Game.system.openAwardsAlert([this.meetingData.costMoney], Games.TEXT.MeetingChengjiaoSure, function () {
                    ...
                    if (enough) {
                        ...
                        var data = Game.moduleModel.meeting.getMeetingData();
                        if (data) {
                            Games.Static.Instance.onUserorbit("meeting", data.pireceIntoDaDianForMaidian(1), "end");
                        }
            ...
            MeetingAskPricePanel.prototype.updateView = function () {
                ...
                if (meetingData) {
                    ...
                    this.m_remainTimes.text = format("{0}/{1}", meetingData.nextMeetingNum, this.meetingData.lineLimit);
                }
                //头像
