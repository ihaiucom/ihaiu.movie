        ...
        var ManagerOrderNeedItem = /** @class */ (function (_super) {
                ...
                if (this.isPut) {
                    ...
                    if (this.isCooperation && this.orderData.isCooperationOrder) {
                        ...
                        if (this.curItemNum >= this.maxItemNum) {
                            ...
                            //道具获取途径
                            Game.system.openItemWay(this.dtItem.itemId, this.maxItemNum);
                        }
                    }
                }
            };
            ...
            ManagerOrderNeedItem.prototype.updateView = function (data, dtItem, isCooperation) {
                ...
                if (this.isPut) {
                    ...
                    this.m_lv.text = max + "";
                    this.m_lv.color = "#50e38a";
                    if (orderItem.portrait == -1) {
                        //自己
                        if (this.uuid == this.orderData.uuid && this.prePut == false && this.isPut == true) {
                            this.m_t0.play(Handler.create(null, function () {
                                _this.m_complete.selectedIndex = 1;
                            }), 1);
                        }
                        else {
                            this.m_t0.stop();
                        ...
                        //头像
                        this.m_head.m_icon.icon = Game.config.headPortrait.GetPlayerIconUrl(orderItem.portrait, Game.moduleModel.cooperation.partnerInfData.sex);
                    }
                }
                else {
