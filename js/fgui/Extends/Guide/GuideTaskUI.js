    ...
    (function (Guide) {
        var GuideTaskUI = /** @class */ (function (_super) {
            ...
            GuideTaskUI.prototype.constructFromXML = function (xml) {
                ...
                this.m_goBtn.text = TEXT.Go;
                this.m_getBtn.text = TEXT.Get;
                this.m_recordsBtn.text = TEXT.Log;
            };
            GuideTaskUI.prototype.onUpdateItemRender = function (index, item) {
                var itemData = this.mainTask.config.reward[index];
                item.updateViewByDTNum(itemData);
            ...
            GuideTaskUI.prototype.onClickGoBtn = function () {
                if (this.mainTask.mainConfig.guide_id > 0) {
                    Game.guide.readyPlayGuide(this.mainTask.mainConfig.guide_id, false);
                    this.onClickCloseBtn();
                }
            };
            //点击
