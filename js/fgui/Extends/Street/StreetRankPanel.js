...
(function (fgui) {
    ...
    (function (Street) {
        var StreetRankPanel = /** @class */ (function (_super) {
            ...
            StreetRankPanel.prototype.OnTick = function (residue_times) {
            ...
            StreetRankPanel.prototype.UpdateView = function () {
                ...
                this.m_streetIcon.isRed = selfStreetData.isCurrent && Game.moduleModel.street.canReward;
            ...
            StreetRankPanel.prototype.UpdateGroupView = function () {
                ...
                if (userData) {
                    this.m_txtGroupMovieRank.text = Games.TEXT.RankText.format(Game.moduleModel.rank.SelfGroupRank);
            ...
            StreetRankPanel.prototype.UpdateMovieView = function () {
                ...
                if (userData && userData.desc.movieName != "") {
                    ...
                    this.m_txtMovieRank.text = userData.rank.toString();
