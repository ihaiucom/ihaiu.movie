    ...
    (function (Common) {
        var TextInputStruct = /** @class */ (function (_super) {
            ...
            TextInputStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("Common", "TextInput"));
            };
            TextInputStruct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
                this.m_title = (this.getChild("title"));
            };
            TextInputStruct.URL = "ui://txcuvopdenjffm";
            TextInputStruct.DependPackages = ["Common"];
            return TextInputStruct;
        }(fairygui.GLabel));
        Common.TextInputStruct = TextInputStruct;
