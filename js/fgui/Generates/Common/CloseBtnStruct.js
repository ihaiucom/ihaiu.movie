    ...
    (function (Common) {
        var CloseBtnStruct = /** @class */ (function (_super) {
            ...
            CloseBtnStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("Common", "closeBtn"));
            };
            ...
            CloseBtnStruct.URL = "ui://txcuvopdx9zq4b";
            CloseBtnStruct.DependPackages = ["Common"];
            return CloseBtnStruct;
        }(fairygui.GButton));
        Common.CloseBtnStruct = CloseBtnStruct;
