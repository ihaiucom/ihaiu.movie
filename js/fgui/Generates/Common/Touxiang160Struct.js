    ...
    (function (Common) {
        var Touxiang160Struct = /** @class */ (function (_super) {
            ...
            Touxiang160Struct.createInstance = function () {
                return (fairygui.UIPackage.createObject("Common", "touxiang160"));
            };
            Touxiang160Struct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
                this.m_icon = (this.getChild("icon"));
            };
            Touxiang160Struct.URL = "ui://txcuvopddsh6t25k";
            Touxiang160Struct.DependPackages = ["Common"];
            return Touxiang160Struct;
        }(fairygui.GLabel));
        Common.Touxiang160Struct = Touxiang160Struct;
