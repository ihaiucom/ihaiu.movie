    ...
    (function (Common) {
        var TopAssetStruct = /** @class */ (function (_super) {
            ...
            TopAssetStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("Common", "TopAsset"));
            };
            ...
            TopAssetStruct.URL = "ui://txcuvopdfv9eab";
            TopAssetStruct.DependPackages = ["Common"];
            return TopAssetStruct;
        }(fairygui.GComponent));
        Common.TopAssetStruct = TopAssetStruct;
