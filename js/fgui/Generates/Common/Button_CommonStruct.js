    ...
    (function (Common) {
        var Button_CommonStruct = /** @class */ (function (_super) {
            ...
            Button_CommonStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("Common", "Button_Common"));
            };
            ...
            Button_CommonStruct.URL = "ui://txcuvopdmu1z2l";
            Button_CommonStruct.DependPackages = ["Common", "PfSkin"];
            return Button_CommonStruct;
        }(fairygui.GButton));
        Common.Button_CommonStruct = Button_CommonStruct;
