    ...
    (function (Common) {
        var StoryItemStruct = /** @class */ (function (_super) {
            ...
            StoryItemStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("Common", "StoryItem"));
            };
            ...
            StoryItemStruct.URL = "ui://txcuvopdcwjyay";
            StoryItemStruct.DependPackages = ["Common", "WarMovie"];
            return StoryItemStruct;
        }(fairygui.GLabel));
        Common.StoryItemStruct = StoryItemStruct;
