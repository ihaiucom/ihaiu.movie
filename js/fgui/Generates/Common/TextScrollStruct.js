    ...
    (function (Common) {
        var TextScrollStruct = /** @class */ (function (_super) {
            ...
            TextScrollStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("Common", "TextScroll"));
            };
            TextScrollStruct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
                this.m_title = (this.getChild("title"));
            };
            TextScrollStruct.URL = "ui://txcuvopdcvs8dp";
            TextScrollStruct.DependPackages = ["Common"];
            return TextScrollStruct;
        }(fairygui.GLabel));
        Common.TextScrollStruct = TextScrollStruct;
