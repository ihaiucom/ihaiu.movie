    ...
    (function (Common) {
        var CommonDialogUIStruct = /** @class */ (function (_super) {
            ...
            CommonDialogUIStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("Common", "CommonDialogUI"));
            };
            CommonDialogUIStruct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
                this.m_visibleCloseBtn = this.getController("visibleCloseBtn");
                this.m_title = (this.getChild("title"));
                this.m_closeBtn = (this.getChild("closeBtn"));
            };
            CommonDialogUIStruct.URL = "ui://txcuvopdnsfy1p";
            CommonDialogUIStruct.DependPackages = ["Common", "System"];
            return CommonDialogUIStruct;
        }(fairygui.GLabel));
        Common.CommonDialogUIStruct = CommonDialogUIStruct;
