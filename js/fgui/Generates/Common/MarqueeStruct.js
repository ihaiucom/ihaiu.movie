    ...
    (function (Common) {
        var MarqueeStruct = /** @class */ (function (_super) {
            ...
            MarqueeStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("Common", "Marquee"));
            };
            MarqueeStruct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
                this.m_way = (this.getChild("way"));
            };
            MarqueeStruct.URL = "ui://txcuvopdenjffs";
            MarqueeStruct.DependPackages = ["Common"];
            return MarqueeStruct;
        }(fairygui.GLabel));
        Common.MarqueeStruct = MarqueeStruct;
