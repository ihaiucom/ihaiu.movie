    ...
    (function (PfSkin) {
        var OscarRewardItemStruct = /** @class */ (function (_super) {
            ...
            OscarRewardItemStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("PfSkin", "OscarRewardItem"));
            };
            ...
            OscarRewardItemStruct.URL = "ui://s33x8418rjg3t1w0";
            OscarRewardItemStruct.DependPackages = ["PfSkin", "Common"];
            return OscarRewardItemStruct;
        }(fairygui.GComponent));
        PfSkin.OscarRewardItemStruct = OscarRewardItemStruct;
