    ...
    (function (PfSkin) {
        var OscarRewardPanelStruct = /** @class */ (function (_super) {
            ...
            OscarRewardPanelStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("PfSkin", "OscarRewardPanel"));
            };
            ...
            OscarRewardPanelStruct.URL = "ui://s33x8418rjg3t1vw";
            OscarRewardPanelStruct.DependPackages = ["PfSkin", "Common"];
            return OscarRewardPanelStruct;
        }(fairygui.GComponent));
        PfSkin.OscarRewardPanelStruct = OscarRewardPanelStruct;
