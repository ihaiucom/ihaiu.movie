    ...
    (function (PfSkin) {
        var ArtistDetailContentStruct = /** @class */ (function (_super) {
            ...
            ArtistDetailContentStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("PfSkin", "ArtistDetailContent"));
            };
            ArtistDetailContentStruct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
                this.m_di = (this.getChild("di"));
            };
            ArtistDetailContentStruct.URL = "ui://s33x8418qr3yt1wm";
            ArtistDetailContentStruct.DependPackages = ["PfSkin", "Common"];
            return ArtistDetailContentStruct;
        }(fairygui.GComponent));
        PfSkin.ArtistDetailContentStruct = ArtistDetailContentStruct;
