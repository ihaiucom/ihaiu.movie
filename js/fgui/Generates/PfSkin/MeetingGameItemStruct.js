    ...
    (function (PfSkin) {
        var MeetingGameItemStruct = /** @class */ (function (_super) {
            ...
            MeetingGameItemStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("PfSkin", "MeetingGameItem"));
            };
            MeetingGameItemStruct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
                this.m_dice = this.getController("dice");
            };
            MeetingGameItemStruct.URL = "ui://s33x8418jzhf1vo";
            MeetingGameItemStruct.DependPackages = ["PfSkin"];
            return MeetingGameItemStruct;
        }(fairygui.GComponent));
        PfSkin.MeetingGameItemStruct = MeetingGameItemStruct;
