    ...
    (function (PfSkin) {
        var MovieInfoItemStruct = /** @class */ (function (_super) {
            ...
            MovieInfoItemStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("PfSkin", "MovieInfoItem"));
            };
            ...
            MovieInfoItemStruct.URL = "ui://s33x8418jakwt1wx";
            MovieInfoItemStruct.DependPackages = ["PfSkin", "Common"];
            return MovieInfoItemStruct;
        }(fairygui.GLabel));
        PfSkin.MovieInfoItemStruct = MovieInfoItemStruct;
