    ...
    (function (PfSkin) {
        var MenuIconStruct = /** @class */ (function (_super) {
            ...
            MenuIconStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("PfSkin", "MenuIcon"));
            };
            ...
            MenuIconStruct.URL = "ui://s33x8418pn361w2";
            MenuIconStruct.DependPackages = ["PfSkin", "Common"];
            return MenuIconStruct;
        }(fairygui.GButton));
        PfSkin.MenuIconStruct = MenuIconStruct;
