    ...
    (function (PfSkin) {
        var OscarAwardsListPanelStruct = /** @class */ (function (_super) {
            ...
            OscarAwardsListPanelStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("PfSkin", "OscarAwardsListPanel"));
            };
            ...
            OscarAwardsListPanelStruct.URL = "ui://s33x8418rjg3t1w1";
            OscarAwardsListPanelStruct.DependPackages = ["PfSkin"];
            return OscarAwardsListPanelStruct;
        }(fairygui.GComponent));
        PfSkin.OscarAwardsListPanelStruct = OscarAwardsListPanelStruct;
