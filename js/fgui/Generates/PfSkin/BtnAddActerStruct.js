    ...
    (function (PfSkin) {
        var BtnAddActerStruct = /** @class */ (function (_super) {
            ...
            BtnAddActerStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("PfSkin", "BtnAddActer"));
            };
            ...
            BtnAddActerStruct.URL = "ui://s33x8418mywn1kj";
            BtnAddActerStruct.DependPackages = ["PfSkin", "Common"];
            return BtnAddActerStruct;
        }(fairygui.GButton));
        PfSkin.BtnAddActerStruct = BtnAddActerStruct;
