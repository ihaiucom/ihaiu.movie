    ...
    (function (PfSkin) {
        var CinemaSelectItemStruct = /** @class */ (function (_super) {
            ...
            CinemaSelectItemStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("PfSkin", "CinemaSelectItem"));
            };
            ...
            CinemaSelectItemStruct.URL = "ui://s33x84186ia7t1v9";
            CinemaSelectItemStruct.DependPackages = ["PfSkin", "Common"];
            return CinemaSelectItemStruct;
        }(fairygui.GButton));
        PfSkin.CinemaSelectItemStruct = CinemaSelectItemStruct;
