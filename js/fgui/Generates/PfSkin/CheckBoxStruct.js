    ...
    (function (PfSkin) {
        var CheckBoxStruct = /** @class */ (function (_super) {
            ...
            CheckBoxStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("PfSkin", "CheckBox"));
            };
            CheckBoxStruct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
                this.m_button = this.getController("button");
            };
            CheckBoxStruct.URL = "ui://s33x8418n2px1n5";
            CheckBoxStruct.DependPackages = ["PfSkin", "Common"];
            return CheckBoxStruct;
        }(fairygui.GButton));
        PfSkin.CheckBoxStruct = CheckBoxStruct;
