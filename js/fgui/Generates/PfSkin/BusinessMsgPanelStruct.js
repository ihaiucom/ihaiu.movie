    ...
    (function (PfSkin) {
        var BusinessMsgPanelStruct = /** @class */ (function (_super) {
            ...
            BusinessMsgPanelStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("PfSkin", "BusinessMsgPanel"));
            };
            ...
            BusinessMsgPanelStruct.URL = "ui://s33x8418jzhf1va";
            BusinessMsgPanelStruct.DependPackages = ["PfSkin"];
            return BusinessMsgPanelStruct;
        }(fairygui.GComponent));
        PfSkin.BusinessMsgPanelStruct = BusinessMsgPanelStruct;
