    ...
    (function (PfSkin) {
        var StreetProgressBarStruct = /** @class */ (function (_super) {
            ...
            StreetProgressBarStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("PfSkin", "StreetProgressBar"));
            };
            ...
            StreetProgressBarStruct.URL = "ui://s33x8418oebq1w0";
            StreetProgressBarStruct.DependPackages = ["PfSkin"];
            return StreetProgressBarStruct;
        }(fairygui.GProgressBar));
        PfSkin.StreetProgressBarStruct = StreetProgressBarStruct;
