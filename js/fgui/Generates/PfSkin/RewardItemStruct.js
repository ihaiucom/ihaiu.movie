    ...
    (function (PfSkin) {
        var RewardItemStruct = /** @class */ (function (_super) {
            ...
            RewardItemStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("PfSkin", "RewardItem"));
            };
            ...
            RewardItemStruct.URL = "ui://s33x8418swip1ua";
            RewardItemStruct.DependPackages = ["PfSkin", "Common"];
            return RewardItemStruct;
        }(fairygui.GButton));
        PfSkin.RewardItemStruct = RewardItemStruct;
