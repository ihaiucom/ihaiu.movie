    ...
    (function (PfSkin) {
        var MeetingGamePanelStruct = /** @class */ (function (_super) {
            ...
            MeetingGamePanelStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("PfSkin", "MeetingGamePanel"));
            };
            ...
            MeetingGamePanelStruct.URL = "ui://s33x8418jzhf1vp";
            MeetingGamePanelStruct.DependPackages = ["PfSkin", "Common"];
            return MeetingGamePanelStruct;
        }(fairygui.GComponent));
        PfSkin.MeetingGamePanelStruct = MeetingGamePanelStruct;
