    ...
    (function (PfSkin) {
        var ShareBtnStruct = /** @class */ (function (_super) {
            ...
            ShareBtnStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("PfSkin", "shareBtn"));
            };
            ShareBtnStruct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
                this.m_button = this.getController("button");
            };
            ShareBtnStruct.URL = "ui://s33x8418dk94t21g";
            ShareBtnStruct.DependPackages = ["PfSkin", "Fx", "WarMovie", "Common"];
            return ShareBtnStruct;
        }(fairygui.GButton));
        PfSkin.ShareBtnStruct = ShareBtnStruct;
