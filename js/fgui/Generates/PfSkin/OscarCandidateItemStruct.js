    ...
    (function (PfSkin) {
        var OscarCandidateItemStruct = /** @class */ (function (_super) {
            ...
            OscarCandidateItemStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("PfSkin", "OscarCandidateItem"));
            };
            ...
            OscarCandidateItemStruct.URL = "ui://s33x8418rjg3t1w4";
            OscarCandidateItemStruct.DependPackages = ["PfSkin", "Common"];
            return OscarCandidateItemStruct;
        }(fairygui.GButton));
        PfSkin.OscarCandidateItemStruct = OscarCandidateItemStruct;
