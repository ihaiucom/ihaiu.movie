    ...
    (function (PfSkin) {
        var MovieIcon_littleStruct = /** @class */ (function (_super) {
            ...
            MovieIcon_littleStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("PfSkin", "movieIcon_little"));
            };
            MovieIcon_littleStruct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
                this.m_icon = (this.getChild("icon"));
            };
            MovieIcon_littleStruct.URL = "ui://s33x8418oebq1vl";
            MovieIcon_littleStruct.DependPackages = ["PfSkin"];
            return MovieIcon_littleStruct;
        }(fairygui.GButton));
        PfSkin.MovieIcon_littleStruct = MovieIcon_littleStruct;
