    ...
    (function (PfSkin) {
        var RankRenamePanelStruct = /** @class */ (function (_super) {
            ...
            RankRenamePanelStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("PfSkin", "RankRenamePanel"));
            };
            ...
            RankRenamePanelStruct.URL = "ui://s33x8418l8141ve";
            RankRenamePanelStruct.DependPackages = ["PfSkin", "Common"];
            return RankRenamePanelStruct;
        }(fairygui.GComponent));
        PfSkin.RankRenamePanelStruct = RankRenamePanelStruct;
