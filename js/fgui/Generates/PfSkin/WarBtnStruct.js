    ...
    (function (PfSkin) {
        var WarBtnStruct = /** @class */ (function (_super) {
            ...
            WarBtnStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("PfSkin", "WarBtn"));
            };
            ...
            WarBtnStruct.URL = "ui://s33x84186ve81ga";
            WarBtnStruct.DependPackages = ["PfSkin"];
            return WarBtnStruct;
        }(fairygui.GButton));
        PfSkin.WarBtnStruct = WarBtnStruct;
