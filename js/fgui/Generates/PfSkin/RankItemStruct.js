    ...
    (function (PfSkin) {
        var RankItemStruct = /** @class */ (function (_super) {
            ...
            RankItemStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("PfSkin", "RankItem"));
            };
            ...
            RankItemStruct.URL = "ui://s33x8418swip1o0";
            RankItemStruct.DependPackages = ["PfSkin", "Common"];
            return RankItemStruct;
        }(fairygui.GLabel));
        PfSkin.RankItemStruct = RankItemStruct;
