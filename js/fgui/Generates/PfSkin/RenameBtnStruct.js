    ...
    (function (PfSkin) {
        var RenameBtnStruct = /** @class */ (function (_super) {
            ...
            RenameBtnStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("PfSkin", "RenameBtn"));
            };
            RenameBtnStruct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
                this.m_button = this.getController("button");
            };
            RenameBtnStruct.URL = "ui://s33x8418jazc1mp";
            RenameBtnStruct.DependPackages = ["PfSkin", "Common"];
            return RenameBtnStruct;
        }(fairygui.GButton));
        PfSkin.RenameBtnStruct = RenameBtnStruct;
