    ...
    (function (PfSkin) {
        var ItemIconStruct = /** @class */ (function (_super) {
            ...
            ItemIconStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("PfSkin", "ItemIcon"));
            };
            ...
            ItemIconStruct.URL = "ui://s33x8418oebq1vy";
            ItemIconStruct.DependPackages = ["PfSkin", "Common"];
            return ItemIconStruct;
        }(fairygui.GButton));
        PfSkin.ItemIconStruct = ItemIconStruct;
