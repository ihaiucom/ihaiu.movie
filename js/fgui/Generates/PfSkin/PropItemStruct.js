    ...
    (function (PfSkin) {
        var PropItemStruct = /** @class */ (function (_super) {
            ...
            PropItemStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("PfSkin", "PropItem"));
            };
            ...
            PropItemStruct.URL = "ui://s33x8418mywn1ko";
            PropItemStruct.DependPackages = ["PfSkin", "MainUI", "Common"];
            return PropItemStruct;
        }(fairygui.GButton));
        PfSkin.PropItemStruct = PropItemStruct;
