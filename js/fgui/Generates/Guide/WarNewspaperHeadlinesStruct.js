    ...
    (function (Guide) {
        var WarNewspaperHeadlinesStruct = /** @class */ (function (_super) {
            ...
            WarNewspaperHeadlinesStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("Guide", "WarNewspaperHeadlines"));
            };
            ...
            WarNewspaperHeadlinesStruct.URL = "ui://toebkrsr7vaw1l";
            WarNewspaperHeadlinesStruct.DependPackages = ["Guide", "Common"];
            return WarNewspaperHeadlinesStruct;
        }(fairygui.GComponent));
        Guide.WarNewspaperHeadlinesStruct = WarNewspaperHeadlinesStruct;
