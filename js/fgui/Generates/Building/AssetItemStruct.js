    ...
    (function (Building) {
        var AssetItemStruct = /** @class */ (function (_super) {
            ...
            AssetItemStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("Building", "AssetItem"));
            };
            AssetItemStruct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
                this.m_assetCtrl = this.getController("assetCtrl");
                this.m_assetNum = (this.getChild("assetNum"));
                this.m_assetLoad = (this.getChild("assetLoad"));
            };
            AssetItemStruct.URL = "ui://d062jvkgo11z122";
            AssetItemStruct.DependPackages = ["Building"];
            return AssetItemStruct;
        }(fairygui.GComponent));
        Building.AssetItemStruct = AssetItemStruct;
