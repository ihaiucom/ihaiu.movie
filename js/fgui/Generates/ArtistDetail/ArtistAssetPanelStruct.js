    ...
    (function (ArtistDetail) {
        var ArtistAssetPanelStruct = /** @class */ (function (_super) {
            ...
            ArtistAssetPanelStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("ArtistDetail", "ArtistAssetPanel"));
            };
            ...
            ArtistAssetPanelStruct.URL = "ui://gif3gjfsjazc1l1";
            ArtistAssetPanelStruct.DependPackages = ["ArtistDetail", "Common"];
            return ArtistAssetPanelStruct;
        }(fairygui.GComponent));
        ArtistDetail.ArtistAssetPanelStruct = ArtistAssetPanelStruct;
