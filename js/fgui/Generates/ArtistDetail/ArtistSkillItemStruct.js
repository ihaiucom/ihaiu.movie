    ...
    (function (ArtistDetail) {
        var ArtistSkillItemStruct = /** @class */ (function (_super) {
            ...
            ArtistSkillItemStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("ArtistDetail", "ArtistSkillItem"));
            };
            ...
            ArtistSkillItemStruct.URL = "ui://gif3gjfsjazc1m2";
            ArtistSkillItemStruct.DependPackages = ["ArtistDetail", "Common", "PfSkin"];
            return ArtistSkillItemStruct;
        }(fairygui.GComponent));
        ArtistDetail.ArtistSkillItemStruct = ArtistSkillItemStruct;
