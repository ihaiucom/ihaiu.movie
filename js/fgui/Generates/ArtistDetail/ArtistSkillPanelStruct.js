    ...
    (function (ArtistDetail) {
        var ArtistSkillPanelStruct = /** @class */ (function (_super) {
            ...
            ArtistSkillPanelStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("ArtistDetail", "ArtistSkillPanel"));
            };
            ...
            ArtistSkillPanelStruct.URL = "ui://gif3gjfsjazc1lb";
            ArtistSkillPanelStruct.DependPackages = ["ArtistDetail", "Common"];
            return ArtistSkillPanelStruct;
        }(fairygui.GComponent));
        ArtistDetail.ArtistSkillPanelStruct = ArtistSkillPanelStruct;
