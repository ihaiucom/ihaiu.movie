    ...
    (function (OpenAnima) {
        var TalkBoxStruct = /** @class */ (function (_super) {
            ...
            TalkBoxStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("OpenAnima", "TalkBox"));
            };
            ...
            TalkBoxStruct.URL = "ui://oyge7e0tbochl";
            TalkBoxStruct.DependPackages = ["OpenAnima"];
            return TalkBoxStruct;
        }(fairygui.GLabel));
        OpenAnima.TalkBoxStruct = TalkBoxStruct;
