...
(function (fgui) {
    var Fx;
    (function (Fx) {
        var Starboom_allneedStruct = /** @class */ (function (_super) {
            __extends(Starboom_allneedStruct, _super);
            function Starboom_allneedStruct() {
                return _super.call(this) || this;
            }
            Starboom_allneedStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("Fx", "starboom_allneed"));
            };
            Starboom_allneedStruct.prototype.constructFromXML = function (xml) {
            ...
            Starboom_allneedStruct.URL = "ui://9l36y1kinmj1ka";
            Starboom_allneedStruct.DependPackages = ["Fx"];
            return Starboom_allneedStruct;
        }(fairygui.GComponent));
        Fx.Starboom_allneedStruct = Starboom_allneedStruct;
    })(Fx = fgui.Fx || (fgui.Fx = {}));
})(fgui || (fgui = {}));
//# sourceMappingURL=Starboom_allneedStruct.js.map