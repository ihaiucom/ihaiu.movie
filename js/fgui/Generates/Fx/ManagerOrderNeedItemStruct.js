    ...
    (function (Fx) {
        var ManagerOrderNeedItemStruct = /** @class */ (function (_super) {
            ...
            ManagerOrderNeedItemStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("Fx", "ManagerOrderNeedItem"));
            };
            ...
            ManagerOrderNeedItemStruct.URL = "ui://9l36y1kio7trng";
            ManagerOrderNeedItemStruct.DependPackages = ["Fx", "Common"];
            return ManagerOrderNeedItemStruct;
        }(fairygui.GButton));
        Fx.ManagerOrderNeedItemStruct = ManagerOrderNeedItemStruct;
    })(Fx = fgui.Fx || (fgui.Fx = {}));
})(fgui || (fgui = {}));
