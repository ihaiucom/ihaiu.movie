...
(function (fgui) {
    var Fx;
    (function (Fx) {
        var StarboomblueStruct = /** @class */ (function (_super) {
            __extends(StarboomblueStruct, _super);
            function StarboomblueStruct() {
                return _super.call(this) || this;
            }
            StarboomblueStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("Fx", "starboomblue"));
            };
            StarboomblueStruct.prototype.constructFromXML = function (xml) {
            ...
            StarboomblueStruct.URL = "ui://9l36y1kic49ilz";
            StarboomblueStruct.DependPackages = ["Fx"];
            return StarboomblueStruct;
        }(fairygui.GComponent));
        Fx.StarboomblueStruct = StarboomblueStruct;
    })(Fx = fgui.Fx || (fgui.Fx = {}));
})(fgui || (fgui = {}));
//# sourceMappingURL=StarboomblueStruct.js.map