    ...
    (function (WarMovie) {
        var Touxiang120Struct = /** @class */ (function (_super) {
            ...
            Touxiang120Struct.createInstance = function () {
                return (fairygui.UIPackage.createObject("WarMovie", "touxiang120"));
            };
            Touxiang120Struct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
                this.m_icon = (this.getChild("icon"));
            };
            Touxiang120Struct.URL = "ui://y6ozucp1cvs8d0";
            Touxiang120Struct.DependPackages = ["WarMovie", "Common"];
            return Touxiang120Struct;
        }(fairygui.GLabel));
        WarMovie.Touxiang120Struct = Touxiang120Struct;
