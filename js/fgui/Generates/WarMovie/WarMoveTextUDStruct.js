    ...
    (function (WarMovie) {
        var WarMoveTextUDStruct = /** @class */ (function (_super) {
            ...
            WarMoveTextUDStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("WarMovie", "WarMoveTextUD"));
            };
            WarMoveTextUDStruct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
                this.m_title = (this.getChild("title"));
            };
            WarMoveTextUDStruct.URL = "ui://y6ozucp1r0zd4w";
            WarMoveTextUDStruct.DependPackages = ["WarMovie"];
            return WarMoveTextUDStruct;
        }(fairygui.GLabel));
        WarMovie.WarMoveTextUDStruct = WarMoveTextUDStruct;
