    ...
    (function (WarMovie) {
        var WarFilmStarStruct = /** @class */ (function (_super) {
            ...
            WarFilmStarStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("WarMovie", "WarFilmStar"));
            };
            WarFilmStarStruct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
                this.m_starList = (this.getChild("starList"));
            };
            WarFilmStarStruct.URL = "ui://y6ozucp1r0zd34";
            WarFilmStarStruct.DependPackages = ["WarMovie"];
            return WarFilmStarStruct;
        }(fairygui.GComponent));
        WarMovie.WarFilmStarStruct = WarFilmStarStruct;
