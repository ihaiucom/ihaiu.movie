    ...
    (function (WarMovie) {
        var ZhuIconStruct = /** @class */ (function (_super) {
            ...
            ZhuIconStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("WarMovie", "ZhuIcon"));
            };
            ZhuIconStruct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
                this.m_icon = (this.getChild("icon"));
            };
            ZhuIconStruct.URL = "ui://y6ozucp1jkgadz";
            ZhuIconStruct.DependPackages = ["WarMovie", "Common"];
            return ZhuIconStruct;
        }(fairygui.GLabel));
        WarMovie.ZhuIconStruct = ZhuIconStruct;
