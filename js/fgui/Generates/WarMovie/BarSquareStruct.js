    ...
    (function (WarMovie) {
        var BarSquareStruct = /** @class */ (function (_super) {
            ...
            BarSquareStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("WarMovie", "BarSquare"));
            };
            BarSquareStruct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
                this.m_t0 = this.getTransition("t0");
            };
            BarSquareStruct.URL = "ui://y6ozucp1wgh5e9";
            BarSquareStruct.DependPackages = ["WarMovie"];
            return BarSquareStruct;
        }(fairygui.GComponent));
        WarMovie.BarSquareStruct = BarSquareStruct;
