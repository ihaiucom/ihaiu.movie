    ...
    (function (WarMovie) {
        var Touxiang80Struct = /** @class */ (function (_super) {
            ...
            Touxiang80Struct.createInstance = function () {
                return (fairygui.UIPackage.createObject("WarMovie", "touxiang80"));
            };
            Touxiang80Struct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
                this.m_icon = (this.getChild("icon"));
            };
            Touxiang80Struct.URL = "ui://y6ozucp1xfnlch";
            Touxiang80Struct.DependPackages = ["WarMovie", "Common"];
            return Touxiang80Struct;
        }(fairygui.GLabel));
        WarMovie.Touxiang80Struct = Touxiang80Struct;
