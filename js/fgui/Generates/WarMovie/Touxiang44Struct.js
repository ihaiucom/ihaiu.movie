    ...
    (function (WarMovie) {
        var Touxiang44Struct = /** @class */ (function (_super) {
            ...
            Touxiang44Struct.createInstance = function () {
                return (fairygui.UIPackage.createObject("WarMovie", "touxiang44"));
            };
            Touxiang44Struct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
                this.m_icon = (this.getChild("icon"));
            };
            Touxiang44Struct.URL = "ui://y6ozucp1xfnlan";
            Touxiang44Struct.DependPackages = ["WarMovie", "Common"];
            return Touxiang44Struct;
        }(fairygui.GLabel));
        WarMovie.Touxiang44Struct = Touxiang44Struct;
