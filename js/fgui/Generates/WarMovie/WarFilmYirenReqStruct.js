    ...
    (function (WarMovie) {
        var WarFilmYirenReqStruct = /** @class */ (function (_super) {
            ...
            WarFilmYirenReqStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("WarMovie", "WarFilmYirenReq"));
            };
            WarFilmYirenReqStruct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
                this.m_icon = (this.getChild("icon"));
            };
            WarFilmYirenReqStruct.URL = "ui://y6ozucp1r0zd5k";
            WarFilmYirenReqStruct.DependPackages = ["WarMovie"];
            return WarFilmYirenReqStruct;
        }(fairygui.GLabel));
        WarMovie.WarFilmYirenReqStruct = WarFilmYirenReqStruct;
