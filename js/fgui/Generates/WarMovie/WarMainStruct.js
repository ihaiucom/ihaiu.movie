    ...
    (function (WarMovie) {
        var WarMainStruct = /** @class */ (function (_super) {
            ...
            WarMainStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("WarMovie", "WarMain"));
            };
            WarMainStruct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
            };
            WarMainStruct.URL = "ui://y6ozucp1qbxl99";
            WarMainStruct.DependPackages = ["WarMovie"];
            return WarMainStruct;
        }(fairygui.GComponent));
        WarMovie.WarMainStruct = WarMainStruct;
