    ...
    (function (WarMovie) {
        var WarActor160Struct = /** @class */ (function (_super) {
            ...
            WarActor160Struct.createInstance = function () {
                return (fairygui.UIPackage.createObject("WarMovie", "WarActor160"));
            };
            WarActor160Struct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
                this.m_icon = (this.getChild("icon"));
            };
            WarActor160Struct.URL = "ui://y6ozucp1qbxl6n";
            WarActor160Struct.DependPackages = ["WarMovie", "Common"];
            return WarActor160Struct;
        }(fairygui.GComponent));
        WarMovie.WarActor160Struct = WarActor160Struct;
