    ...
    (function (WarMovie) {
        var WarContinuousIncomeStruct = /** @class */ (function (_super) {
            ...
            WarContinuousIncomeStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("WarMovie", "WarContinuousIncome"));
            };
            ...
            WarContinuousIncomeStruct.URL = "ui://y6ozucp1qbxl84";
            WarContinuousIncomeStruct.DependPackages = ["WarMovie", "System", "Common", "Fx"];
            return WarContinuousIncomeStruct;
        }(fairygui.GComponent));
        WarMovie.WarContinuousIncomeStruct = WarContinuousIncomeStruct;
