    ...
    (function (Oscar) {
        var AwardsInfoItemtsStruct = /** @class */ (function (_super) {
            ...
            AwardsInfoItemtsStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("Oscar", "AwardsInfoItem.ts"));
            };
            ...
            AwardsInfoItemtsStruct.URL = "ui://spuqgpclyyljt";
            AwardsInfoItemtsStruct.DependPackages = ["Oscar", "Common"];
            return AwardsInfoItemtsStruct;
        }(fairygui.GButton));
        Oscar.AwardsInfoItemtsStruct = AwardsInfoItemtsStruct;
