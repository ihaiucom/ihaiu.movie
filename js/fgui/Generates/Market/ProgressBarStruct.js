    ...
    (function (Market) {
        var ProgressBarStruct = /** @class */ (function (_super) {
            ...
            ProgressBarStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("Market", "ProgressBar"));
            };
            ...
            ProgressBarStruct.URL = "ui://p7g5z54adm31ax";
            ProgressBarStruct.DependPackages = ["Market"];
            return ProgressBarStruct;
        }(fairygui.GProgressBar));
        Market.ProgressBarStruct = ProgressBarStruct;
