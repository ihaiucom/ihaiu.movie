    ...
    (function (Market) {
        var BtnLeftStruct = /** @class */ (function (_super) {
            ...
            BtnLeftStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("Market", "btnLeft"));
            };
            BtnLeftStruct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
                this.m_button = this.getController("button");
            };
            BtnLeftStruct.URL = "ui://p7g5z54acp1cfm";
            BtnLeftStruct.DependPackages = ["Market"];
            return BtnLeftStruct;
        }(fairygui.GButton));
        Market.BtnLeftStruct = BtnLeftStruct;
