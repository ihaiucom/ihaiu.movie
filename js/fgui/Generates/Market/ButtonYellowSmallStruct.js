    ...
    (function (Market) {
        var ButtonYellowSmallStruct = /** @class */ (function (_super) {
            ...
            ButtonYellowSmallStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("Market", "ButtonYellowSmall"));
            };
            ...
            ButtonYellowSmallStruct.URL = "ui://p7g5z54akkdsfl";
            ButtonYellowSmallStruct.DependPackages = ["Market"];
            return ButtonYellowSmallStruct;
        }(fairygui.GButton));
        Market.ButtonYellowSmallStruct = ButtonYellowSmallStruct;
