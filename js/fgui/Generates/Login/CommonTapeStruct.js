    ...
    (function (Login) {
        var CommonTapeStruct = /** @class */ (function (_super) {
            ...
            CommonTapeStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("Login", "CommonTape"));
            };
            CommonTapeStruct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
                this.m_t1 = this.getTransition("t1");
            };
            CommonTapeStruct.URL = "ui://7znsj5i6wrr65o";
            CommonTapeStruct.DependPackages = ["Login"];
            return CommonTapeStruct;
        }(fairygui.GComponent));
        Login.CommonTapeStruct = CommonTapeStruct;
