    ...
    (function (Login) {
        var AccountInputStruct = /** @class */ (function (_super) {
            ...
            AccountInputStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("Login", "accountInput"));
            };
            ...
            AccountInputStruct.URL = "ui://7znsj5i6cpc91k";
            AccountInputStruct.DependPackages = ["Login"];
            return AccountInputStruct;
        }(fairygui.GComponent));
        Login.AccountInputStruct = AccountInputStruct;
    })(Login = fgui.Login || (fgui.Login = {}));
})(fgui || (fgui = {}));
//# sourceMappingURL=AccountInputStruct.js.map