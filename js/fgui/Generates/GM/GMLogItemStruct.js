    ...
    (function (GM) {
        var GMLogItemStruct = /** @class */ (function (_super) {
            ...
            GMLogItemStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("GM", "GMLogItem"));
            };
            ...
            GMLogItemStruct.DependPackages = ["GM"];
            return GMLogItemStruct;
        }(fairygui.GLabel));
        GM.GMLogItemStruct = GMLogItemStruct;
    })(GM = fgui.GM || (fgui.GM = {}));
})(fgui || (fgui = {}));
//# sourceMappingURL=GMLogItemStruct.js.map