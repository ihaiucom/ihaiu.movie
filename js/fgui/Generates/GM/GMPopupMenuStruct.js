    ...
    (function (GM) {
        var GMPopupMenuStruct = /** @class */ (function (_super) {
            ...
            GMPopupMenuStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("GM", "GMPopupMenu"));
            };
            ...
            GMPopupMenuStruct.DependPackages = ["GM"];
            return GMPopupMenuStruct;
        }(fairygui.GComponent));
        GM.GMPopupMenuStruct = GMPopupMenuStruct;
    })(GM = fgui.GM || (fgui.GM = {}));
})(fgui || (fgui = {}));
//# sourceMappingURL=GMPopupMenuStruct.js.map