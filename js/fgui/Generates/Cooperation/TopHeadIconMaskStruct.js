    ...
    (function (Cooperation) {
        var TopHeadIconMaskStruct = /** @class */ (function (_super) {
            ...
            TopHeadIconMaskStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("Cooperation", "TopHeadIconMask"));
            };
            TopHeadIconMaskStruct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
                this.m_icon = (this.getChild("icon"));
            };
            TopHeadIconMaskStruct.URL = "ui://k9ycebr5pazr2g";
            TopHeadIconMaskStruct.DependPackages = ["Cooperation"];
            return TopHeadIconMaskStruct;
        }(fairygui.GButton));
        Cooperation.TopHeadIconMaskStruct = TopHeadIconMaskStruct;
