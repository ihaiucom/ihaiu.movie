    ...
    (function (Street) {
        var RankItemStruct = /** @class */ (function (_super) {
            ...
            RankItemStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("Street", "RankItem"));
            };
            ...
            RankItemStruct.URL = "ui://mu4e45moh9ou1h";
            RankItemStruct.DependPackages = ["Street", "Common", "PfSkin"];
            return RankItemStruct;
        }(fairygui.GLabel));
        Street.RankItemStruct = RankItemStruct;
