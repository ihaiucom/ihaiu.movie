    ...
    (function (Street) {
        var ActorCircleItemStruct = /** @class */ (function (_super) {
            ...
            ActorCircleItemStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("Street", "ActorCircleItem"));
            };
            ActorCircleItemStruct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
                this.m_icon = (this.getChild("icon"));
            };
            ActorCircleItemStruct.URL = "ui://mu4e45moh9ou1e";
            ActorCircleItemStruct.DependPackages = ["Street", "Common"];
            return ActorCircleItemStruct;
        }(fairygui.GLabel));
        Street.ActorCircleItemStruct = ActorCircleItemStruct;
