    ...
    (function (PlayerInfo) {
        var BarSquareStruct = /** @class */ (function (_super) {
            ...
            BarSquareStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("PlayerInfo", "BarSquare"));
            };
            BarSquareStruct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
            };
            BarSquareStruct.URL = "ui://tderqmz5dyfe3";
            BarSquareStruct.DependPackages = ["PlayerInfo", "Common"];
            return BarSquareStruct;
        }(fairygui.GComponent));
        PlayerInfo.BarSquareStruct = BarSquareStruct;
