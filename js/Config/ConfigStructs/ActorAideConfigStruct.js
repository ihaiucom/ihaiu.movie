...
(function (configs) {
    var ActorAideConfigStruct = /** @class */ (function (_super) {
        ...
        Object.defineProperty(ActorAideConfigStruct.prototype, "name", {
            get: function () {
                var value = LangManager.Instance.getValue("actorAide", this.id, "name");
    ...
    configs.ActorAideConfigStruct = ActorAideConfigStruct;
})(configs || (configs = {}));
//# sourceMappingURL=ActorAideConfigStruct.js.map