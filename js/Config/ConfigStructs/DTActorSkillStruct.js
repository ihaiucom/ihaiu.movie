...
(function (configs) {
    var DTActorSkillStruct = /** @class */ (function (_super) {
        ...
        DTActorSkillStruct.parse = function (txt) {
            ...
            var config = new configs.DTActorSkill();
        ...
        DTActorSkillStruct.parseArray = function (txt) {
            ...
            for (var i = 0; i < csv.length; i++) {
                list.push(configs.DTActorSkill.parse(csv[i]));
            }
            return list;
        };
        return DTActorSkillStruct;
    }(configs.BaseConfig));
    configs.DTActorSkillStruct = DTActorSkillStruct;
})(configs || (configs = {}));
//# sourceMappingURL=DTActorSkillStruct.js.map