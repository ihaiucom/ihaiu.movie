...
(function (configs) {
    var DTActorFeatureStruct = /** @class */ (function (_super) {
        ...
        DTActorFeatureStruct.parse = function (txt) {
            ...
            var config = new configs.DTActorFeature();
        ...
        DTActorFeatureStruct.parseArray = function (txt) {
            ...
            for (var i = 0; i < csv.length; i++) {
                list.push(configs.DTActorFeature.parse(csv[i]));
            }
            return list;
        };
        return DTActorFeatureStruct;
    }(configs.BaseConfig));
    configs.DTActorFeatureStruct = DTActorFeatureStruct;
})(configs || (configs = {}));
//# sourceMappingURL=DTActorFeatureStruct.js.map