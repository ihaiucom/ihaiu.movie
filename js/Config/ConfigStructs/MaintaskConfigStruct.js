...
(function (configs) {
    var MaintaskConfigStruct = /** @class */ (function (_super) {
        ...
        Object.defineProperty(MaintaskConfigStruct.prototype, "name", {
            get: function () {
                var value = LangManager.Instance.getValue("maintask", this.id, "name");
        ...
        Object.defineProperty(MaintaskConfigStruct.prototype, "info", {
            get: function () {
                var value = LangManager.Instance.getValue("maintask", this.id, "info");
                if (!isNullOrEmpty(value)) {
                    return value;
                }
                return this.cn_info;
        ...
        Object.defineProperty(MaintaskConfigStruct.prototype, "cinfo", {
            get: function () {
                var value = LangManager.Instance.getValue("maintask", this.id, "cinfo");
                if (!isNullOrEmpty(value)) {
                    return value;
                }
        ...
        Object.defineProperty(MaintaskConfigStruct.prototype, "content", {
            get: function () {
                var value = LangManager.Instance.getValue("maintask", this.id, "content");
                if (!isNullOrEmpty(value)) {
                    return value;
                }
