...
(function (configs) {
    var CupPackageConfigStruct = /** @class */ (function (_super) {
        ...
        Object.defineProperty(CupPackageConfigStruct.prototype, "name", {
            get: function () {
                var value = LangManager.Instance.getValue("cupPackage", this.id, "name");
        ...
        Object.defineProperty(CupPackageConfigStruct.prototype, "des", {
            get: function () {
                var value = LangManager.Instance.getValue("cupPackage", this.id, "des");
                if (!isNullOrEmpty(value)) {
                    return value;
                }
    ...
    configs.CupPackageConfigStruct = CupPackageConfigStruct;
})(configs || (configs = {}));
//# sourceMappingURL=CupPackageConfigStruct.js.map