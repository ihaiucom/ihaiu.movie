...
(function (configs) {
    var WeeklyQuestConfigStruct = /** @class */ (function (_super) {
        ...
        Object.defineProperty(WeeklyQuestConfigStruct.prototype, "name", {
            get: function () {
                var value = LangManager.Instance.getValue("weeklyQuest", this.id, "name");
        ...
        Object.defineProperty(WeeklyQuestConfigStruct.prototype, "des", {
            get: function () {
                var value = LangManager.Instance.getValue("weeklyQuest", this.id, "des");
                if (!isNullOrEmpty(value)) {
                    return value;
                }
    ...
    configs.WeeklyQuestConfigStruct = WeeklyQuestConfigStruct;
})(configs || (configs = {}));
//# sourceMappingURL=WeeklyQuestConfigStruct.js.map