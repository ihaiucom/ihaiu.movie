...
(function (configs) {
    var BlockLevelConfigReader = /** @class */ (function (_super) {
        ...
        BlockLevelConfigReader.prototype.getBlockIconUrl = function (stall) {
            var cfg = Game.config.blockLevel.getConfig(stall);
            if (cfg) {
                return Game.config.avatar.GetIconUrl(cfg.pic);
            }
            return "";
        };
        Object.defineProperty(BlockLevelConfigReader.prototype, "CityEnvoyMaxStreet", {
            get: function () {
                var list = this.getConfigList();
                var cfg = list.findOne(function (value) {
                    return value.city_envoy_max == 1;
                });
                if (cfg) {
                    return cfg.id;
                }
