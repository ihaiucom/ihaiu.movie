...
var GlobalKey = /** @class */ (function () {
    ...
    /** 55   --- 初始每日金币兑换次数 */
    GlobalKey.Conversion_Initial_Times = "Conversion_Initial_Times";
    /** 56   --- 金币兑换每日刷新时间（每日N点） */
    GlobalKey.Conversion_Refresh_Time = "Conversion_Refresh_Time";
    /** 57   --- 剧本刷新每日重置时间（点） */
    GlobalKey.Shoot_Story_Refresh_ResetTime = "Shoot_Story_Refresh_ResetTime";
    /** 1001   --- 探查消耗 */
    ...
    /** 1050   --- 财务员NPC模型ID */
    GlobalKey.KEY_1050 = "KEY_1050";
    /** 1051   --- NPC1ID */
    GlobalKey.KEY_1051 = "KEY_1051";
    /** 1052   --- NPC2ID */
    GlobalKey.KEY_1052 = "KEY_1052";
    /** 1053   --- NPC3ID */
    GlobalKey.KEY_1053 = "KEY_1053";
    /** 1054   --- NPC4ID */
    GlobalKey.KEY_1054 = "KEY_1054";
    /** 1055   --- 助理 */
    GlobalKey.KEY_1055 = "KEY_1055";
    /** 1056   --- 限时艺人购买全价钻石消耗 */
    GlobalKey.KEY_1056 = "KEY_1056";
    /** 1057   --- 限时艺人购买打折钻石消耗 */
    GlobalKey.KEY_1057 = "KEY_1057";
    /** 1058   --- 限时艺人购买打折时间(小时) */
    GlobalKey.KEY_1058 = "KEY_1058";
    /** 2003   --- 剧本成本随机 */
    ...
    /** 2083   --- 头像更换解锁等级 */
    GlobalKey.account_lock = "account_lock";
    /** 2084   --- 普通任务数量限制 */
    GlobalKey.common_task_amount = "common_task_amount";
    /** 2085   --- 每日任务更换次数 */
    GlobalKey.common_task_change_times = "common_task_change_times";
    /** 2086   --- 小秘书价格临时显示（人民币） */
    GlobalKey.secretary_price = "secretary_price";
    /** 2087   --- 小秘书礼包价格临时显示（人民币） */
    GlobalKey.secretary_package = "secretary_package";
    /** 2088   --- 占领城市其他产出单位时间 */
    GlobalKey.city_random_item_time = "city_random_item_time";
    /** 2089   --- 电影后续收益道具产出单位时间 */
    GlobalKey.movie_output_unit_time = "movie_output_unit_time";
    /** 2090   --- 玩家初始剧本 */
    GlobalKey.player_story_start = "player_story_start";
    /** 2091   --- 剧情主角等级 */
    GlobalKey.story_leader_actor_level = "story_leader_actor_level";
    /** 2092   --- 平均值取值范围 */
    GlobalKey.first_story_att = "first_story_att";
    /** 2093   --- 首部电影媒体评价取值范围 */
    GlobalKey.first_story_evaluate = "first_story_evaluate";
    /** 2094   --- 首部电影观众口碑取值范围 */
    GlobalKey.first_story_opinions = "first_story_opinions";
    /** 2095   --- 首部电影随机取值 */
    GlobalKey.first_story_random_con = "first_story_random_con";
    /** 2096   --- 首部电影经验值 */
    GlobalKey.first_story_exp = "first_story_exp";
    /** 2097   --- 触发新手引导完成奖励展示的新手任务ID */
    GlobalKey.maintask_complete_start = "maintask_complete_start";
    /** 2098   --- 新手引导全部完成的新手任务ID */
    GlobalKey.maintask_complete_end = "maintask_complete_end";
    /** 2099   --- 新手全部完成奖励的艺人ID */
    GlobalKey.maintask_complete_reward = "maintask_complete_reward";
    /** 2100   --- 第三天五星剧本ID */
    GlobalKey.three_story = "three_story";
    /** 2101   --- 第三天首部电影平均值取值范围 */
    GlobalKey.three_story_att = "three_story_att";
    /** 2102   --- 第三天首部电影媒体评价取值范围 */
    GlobalKey.three_story_evaluate = "three_story_evaluate";
    /** 2103   --- 第三天首部电影观众口碑取值范围 */
    GlobalKey.three_story_opinions = "three_story_opinions";
    /** 2104   --- 第三天首部电影随机取值 */
    GlobalKey.three_storyrandom_con = "three_storyrandom_con";
    /** 2105   --- 新手引导全部完成的奖励展示海报 */
    GlobalKey.maintask_complete_image = "maintask_complete_image";
    /** 3001   --- 小转盘保底次数 */
    GlobalKey.wheel1_count = "wheel1_count";
    /** 3002   --- 大转盘保底次数 */
    GlobalKey.wheel2_count = "wheel2_count";
    /** 3003   --- 小转盘消耗道具 */
    GlobalKey.wheel1_cost_id = "wheel1_cost_id";
    /** 3004   --- 大转盘消耗道具 */
    GlobalKey.wheel2_cost_id = "wheel2_cost_id";
    return GlobalKey;
}());
