...
(function (configs) {
    var DTItemNum = /** @class */ (function (_super) {
        ...
        Object.defineProperty(DTItemNum.prototype, "isBagType", {
            //是否是资产 
            get: function () {
                return this.itemType == 4 || this.itemType == 5 || this.itemType == 6 || this.itemType == 7 || this.itemType == 8 || this.itemType == 9;
            },
            enumerable: true,
            configurable: true
        });
