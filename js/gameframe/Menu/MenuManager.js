    ...
    var MenuManager = /** @class */ (function () {
            ...
            for (var _i = 0, _a = this.list; _i < _a.length; _i++) {
                ...
                switch (item.state) {
                    case Games.MenuCtlStateType.Opened:
                        ...
                        if (item.menuConfig.menuLayer == Games.MenuLayerType.Module || item.menuConfig.menuLayer == Games.MenuLayerType.ModuleTop) {
                            moduleOpenedNum++;
                        }
                        break;
                }
        ...
        MenuManager.prototype.getLastModuleOpenMenuId = function (excludeMenuId) {
            for (var i = this.stack.length - 1; i >= 0; i--) {
                ...
                if (ctl.menuConfig.menuLayer == Games.MenuLayerType.Module || ctl.menuConfig.menuLayer == Games.MenuLayerType.ModuleTop) {
            ...
            for (var i = 0; i < this.list.length; i++) {
                ...
                if (ctl.state == Games.MenuCtlStateType.Closed) {
                    if (ctl.menuConfig.cacheTime != -1) {
                        var cacheTime = Math.max(ctl.menuConfig.cacheTime, gameDeviceConfig.menuCacheTime);
