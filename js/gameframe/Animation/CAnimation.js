...
(function (Games) {
    ...
    var CAnimation = /** @class */ (function () {
         ...
         * @param error         解析失败回调
         */
        CAnimation.prototype.loadAnim = function (texturePath, skeletonPath, parent, caller, complete, error) {
        ...
        */
        CAnimation.prototype.onSkeletonComplete = function (skeleton) {
            ...
            if (!this.animator.destroyed) {
                this.animator.on(Event.STOPPED, this, this.onSkeletonPlayEnd);
                // this.animator.showSkinByIndex(0);
                this.playLast();
                var displayIndex = this.parent.numChildren > 0 ? 1 : 0;
                this.parent.addChildAt(this.animator, displayIndex);
