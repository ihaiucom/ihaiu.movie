...
(function (Games) {
    ...
    var cooperateHandler = /** @class */ (function (_super) {
         ...
         *  合作建立界面 1秒一次
         */
        // GetSetUpInfo(msg: Proto.API.cooperate.GetSetUpInfoResponse)
        // {
        // }
        /**
         *  合作任务界面 2秒一次
         */
        cooperateHandler.prototype.GetTaskInfo = function (msg) {
        };
        /**
         *  合作订单界面 2秒一次
         */
        cooperateHandler.prototype.GetOrderInfo = function (msg) {
        };
