...
(function (Games) {
    ...
    var rankHandler = /** @class */ (function (_super) {
        ...
        rankHandler.prototype.GetOscarData = function (msg) {
            Game.moduleModel.oscar.OnOscarDataUpdate();
        };
        /**
         *
         */
        rankHandler.prototype.GetOscarReward = function (msg) {
            ...
            if (dropList && dropList.length > 0) {
                dropList = dropList.sort(function (a, b) { return a.itemId - b.itemId; });
        ...
        rankHandler.prototype.GetStreetReward = function (msg) {
            ...
            Game.system.getRewardText(list, Games.TEXT.MarketReward, 0);
        };
        /**
         *  获取自己的排名信息
         */
        ...
        rankHandler.prototype.GetServerListReward = function (msg) {
            ...
            var rewardId = 0;
            if (list.length > 0) {
                rewardId = list[0].itemId;
            }
            Games.Static.Instance.onUserorbit("rank", User.info.stall + "&" + Game.moduleModel.rank.rankInfo.lastGroupId + "&" + Game.moduleModel.rank.rankInfo.lastRank + "&" + rewardId, "end");
        };
        /**
         *  修改服务器名称
         */
