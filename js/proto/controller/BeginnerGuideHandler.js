...
(function (Games) {
    ...
    var BeginnerGuideHandler = /** @class */ (function (_super) {
         ...
         *
         */
        BeginnerGuideHandler.prototype.GuideEndReward = function (msg) {
            var data = Game.moduleModel.actor.getActor(Game.moduleModel.task.guideCompleteRewardID);
            if (data) {
                Game.menu.open(Games.MenuId.ArtistScoutSuccess, data, false);
                // 埋点 星探招募
            ...
            Game.event.dispatch(GameEventKey.GameEventKey_UnlockChange, Games.UnlockID.GuideComplete);
        };
