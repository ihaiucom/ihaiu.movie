    ...
    var ActorSender = /** @class */ (function (_super) {
        ...
        ActorSender.prototype.noseInfoActor = function (isUseCard) {
            if (isUseCard) {
                ...
                // 埋点 星探招募
                Games.Static.Instance.onResourceinput([dtCost], "star&clearCD", -1, -1);
            }
         ...
         * @param id   助理id
         */
        ActorSender.prototype.AssistantUpLv = function (uuid, id) {
            var req = new Proto.API.Actor.AssistantUpLvRequest();
            req.uuid = uuid;
            req.id = id;
            this.send(req);
        };
