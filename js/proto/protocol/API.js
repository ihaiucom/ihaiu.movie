...
(function (Proto) {
    ...
    (function (API) {
        ...
        (function (GameData) {
            ...
            var VisitorAuthRequest = /** @class */ (function () {
                function VisitorAuthRequest() {
                    this.name = ""; // 用户名
                    this.pass = ""; // 密码
                }
                return VisitorAuthRequest;
            }());
            GameData.VisitorAuthRequest = VisitorAuthRequest;
            var VisitorAuthResponse = /** @class */ (function () {
                function VisitorAuthResponse() {
                    this.result = 0; // 返回 0成功 1不是游客账号 2绑定失败 3重名
                }
                return VisitorAuthResponse;
            }());
            GameData.VisitorAuthResponse = VisitorAuthResponse;
        ...
        (function (CinemaBuild) {
            ...
            var goldExchangeRequest = /** @class */ (function () {
                function goldExchangeRequest() {
                    this.count = 0; // 兑换的次数
                }
                return goldExchangeRequest;
            }());
            CinemaBuild.goldExchangeRequest = goldExchangeRequest;
            var goldExchangeResponse = /** @class */ (function () {
                function goldExchangeResponse() {
                    this.result = 0; // 0,成功，非0，错误码
                    this.count = 0; // 兑换次数
                    this.totalCount = 0; // 今日已经兑换的次数
                }
                return goldExchangeResponse;
            }());
            CinemaBuild.goldExchangeResponse = goldExchangeResponse;
        ...
        (function (test) {
            ...
            var AddManageRequest = /** @class */ (function () {
                function AddManageRequest() {
                }
                return AddManageRequest;
            }());
            test.AddManageRequest = AddManageRequest;
            var AddManageResponse = /** @class */ (function () {
                function AddManageResponse() {
                }
                return AddManageResponse;
            }());
            test.AddManageResponse = AddManageResponse;
            var SetAllActorLvRequest = /** @class */ (function () {
                function SetAllActorLvRequest() {
                }
                return SetAllActorLvRequest;
            }());
            test.SetAllActorLvRequest = SetAllActorLvRequest;
            var SetAllActorLvResponse = /** @class */ (function () {
                function SetAllActorLvResponse() {
                }
                return SetAllActorLvResponse;
            }());
            test.SetAllActorLvResponse = SetAllActorLvResponse;
        ...
        (function (item) {
            ...
            var UsePiecesGiftBagRequest = /** @class */ (function () {
                function UsePiecesGiftBagRequest() {
                    this.uuid = ""; // 道具唯一编号
                    this.itemId = 0; // 道具id
                    this.amount = 0; // 道具数量
                    this.selItemId = 0; // 选择的物品ID
                }
                return UsePiecesGiftBagRequest;
            }());
            item.UsePiecesGiftBagRequest = UsePiecesGiftBagRequest;
            var UsePiecesGiftBagResponse = /** @class */ (function () {
                function UsePiecesGiftBagResponse() {
                    this.uuid = ""; // 道具唯一编号
                    this.dropout = null; // 掉落物品
                }
                return UsePiecesGiftBagResponse;
            }());
            item.UsePiecesGiftBagResponse = UsePiecesGiftBagResponse;
        ...
        (function (movie) {
            ...
            var RefreshMovieStoryRequest = /** @class */ (function () {
                function RefreshMovieStoryRequest() {
                    this.uuid = ""; // 电影唯一编号
                }
                return RefreshMovieStoryRequest;
            }());
            movie.RefreshMovieStoryRequest = RefreshMovieStoryRequest;
            var RefreshMovieStoryResponse = /** @class */ (function () {
                function RefreshMovieStoryResponse() {
                    this.uuid = ""; // 电影唯一编号
                }
                return RefreshMovieStoryResponse;
            }());
            movie.RefreshMovieStoryResponse = RefreshMovieStoryResponse;
        ...
        (function (Actor) {
            ...
            var AssistantUpLvRequest = /** @class */ (function () {
                function AssistantUpLvRequest() {
                    this.uuid = ""; // 艺人uuid
                    this.id = 0; // 助理id
                }
                return AssistantUpLvRequest;
            }());
            Actor.AssistantUpLvRequest = AssistantUpLvRequest;
            var AssistantUpLvResponse = /** @class */ (function () {
                function AssistantUpLvResponse() {
                    this.uuid = ""; // 艺人uuid
                    this.id = 0; // 助理id
                }
                return AssistantUpLvResponse;
            }());
            Actor.AssistantUpLvResponse = AssistantUpLvResponse;
        ...
        (function (manageVisit) {
            ...
            var StartReceRequest = /** @class */ (function () {
                function StartReceRequest() {
                }
                return StartReceRequest;
            }());
            manageVisit.StartReceRequest = StartReceRequest;
            var StartReceResponse = /** @class */ (function () {
                function StartReceResponse() {
                }
                return StartReceResponse;
            }());
            manageVisit.StartReceResponse = StartReceResponse;
        ...
        (function (BeginnerGuide) {
            ...
            var GuideEndRewardRequest = /** @class */ (function () {
                function GuideEndRewardRequest() {
                }
                return GuideEndRewardRequest;
            }());
            BeginnerGuide.GuideEndRewardRequest = GuideEndRewardRequest;
            var GuideEndRewardResponse = /** @class */ (function () {
                function GuideEndRewardResponse() {
                    this.isNewActor = false; // 没有为true
                }
                return GuideEndRewardResponse;
            }());
            BeginnerGuide.GuideEndRewardResponse = GuideEndRewardResponse;
        ...
        (function (cooperate) {
            ...
            var GetTaskInfoRequest = /** @class */ (function () {
                function GetTaskInfoRequest() {
                }
                return GetTaskInfoRequest;
            }());
            cooperate.GetTaskInfoRequest = GetTaskInfoRequest;
            var GetTaskInfoResponse = /** @class */ (function () {
                function GetTaskInfoResponse() {
                }
                return GetTaskInfoResponse;
            }());
            cooperate.GetTaskInfoResponse = GetTaskInfoResponse;
            var GetOrderInfoRequest = /** @class */ (function () {
                function GetOrderInfoRequest() {
                    this.oldOrderUuids = null;
                }
                return GetOrderInfoRequest;
            }());
            cooperate.GetOrderInfoRequest = GetOrderInfoRequest;
            var GetOrderInfoResponse = /** @class */ (function () {
                function GetOrderInfoResponse() {
                }
                return GetOrderInfoResponse;
            }());
            cooperate.GetOrderInfoResponse = GetOrderInfoResponse;
        })(cooperate = API.cooperate || (API.cooperate = {}));
        var pay;
        (function (pay) {
            var StartOrderRequest = /** @class */ (function () {
                function StartOrderRequest() {
                    this.id = 0; // 商品id
                    this.amount = 0; // 数量
                }
                return StartOrderRequest;
            }());
            pay.StartOrderRequest = StartOrderRequest;
            var StartOrderResponse = /** @class */ (function () {
                function StartOrderResponse() {
                    this.id = 0; // 商品id
                    this.amount = 0; // 数量
                    this.orderId = ""; // 订单id
                }
            ...
            pay.StartOrderResponse = StartOrderResponse;
            var FinishOrderRequest = /** @class */ (function () {
                function FinishOrderRequest() {
                    this.orderId = ""; // 订单id
                    this.result = 0; // 结果 0 成功, 1 失败
                }
                return FinishOrderRequest;
            }());
            pay.FinishOrderRequest = FinishOrderRequest;
            var FinishOrderResponse = /** @class */ (function () {
                function FinishOrderResponse() {
                    this.orderId = ""; // 订单id
                    this.result = 0; // 结果 0 成功, 1 失败
            ...
            pay.FinishOrderResponse = FinishOrderResponse;
        })(pay = API.pay || (API.pay = {}));
        var chat;
        (function (chat) {
            var MessageNoticeRequest = /** @class */ (function () {
                function MessageNoticeRequest() {
                    this.channel = 0;
                }
                return MessageNoticeRequest;
            }());
            chat.MessageNoticeRequest = MessageNoticeRequest;
            var MessageNoticeResponse = /** @class */ (function () {
                function MessageNoticeResponse() {
                    this.roomId = 0; // 房间号，世界频道时：为0
                    this.newMessage = null;
                }
                return MessageNoticeResponse;
            }());
            chat.MessageNoticeResponse = MessageNoticeResponse;
            var NewMessageRequest = /** @class */ (function () {
                function NewMessageRequest() {
                }
                return NewMessageRequest;
            }());
            chat.NewMessageRequest = NewMessageRequest;
            var NewMessageResponse = /** @class */ (function () {
                function NewMessageResponse() {
                    this.worldInfo = null; // 世界频道,新消息总数量
                    this.privateInfo = null; // 私人频道,新消息总数量
                    this.companyInfo = null; // 公司频道，新消息总数量
                }
                return NewMessageResponse;
            }());
            chat.NewMessageResponse = NewMessageResponse;
            var AllMessageRequest = /** @class */ (function () {
                function AllMessageRequest() {
                }
                return AllMessageRequest;
            }());
            chat.AllMessageRequest = AllMessageRequest;
            var AllMessageResponse = /** @class */ (function () {
                function AllMessageResponse() {
                    this.worldUserInfo = null; // 世界频道
                    this.worldSystemInfo = null; // 世界频道
                    this.privateInfo = null; // 私人频道
                    this.companyInfo = null; // 公司频道
                }
                return AllMessageResponse;
            }());
            chat.AllMessageResponse = AllMessageResponse;
            var SendMessageRequest = /** @class */ (function () {
                function SendMessageRequest() {
                    this.message = ""; // 信息
                    this.recipient = 0; // 接收者
                    this.roomId = 0; // 房间号，如果是世界频道，不判断该字段
                    this.channel = 0; // 频道
                }
            ...
            var PullMessageRequest = /** @class */ (function () {
                function PullMessageRequest() {
                    this.channel = 0; // 频道
                    this.roomId = 0; // 房间号，如果是世界频道，不判断该字段
                    this.messageId = 0; // 0：新消息，非0：旧消息
                }
                return PullMessageRequest;
            }());
            chat.PullMessageRequest = PullMessageRequest;
            var PullMessageResponse = /** @class */ (function () {
                function PullMessageResponse() {
                    this.messageInfo = null; // 最新玩家消息
                    this.systemMessageInfo = null; // 最新系统消息
                    this.channel = 0; // 频道
                    this.roomId = 0; // 房间号，如果是世界频道，不判断该字段
                }
                return PullMessageResponse;
            }());
            chat.PullMessageResponse = PullMessageResponse;
            var SheieldingRequest = /** @class */ (function () {
                function SheieldingRequest() {
                    this.userId = 0; // 玩家id
                }
                return SheieldingRequest;
            }());
            chat.SheieldingRequest = SheieldingRequest;
            var SheieldingResponse = /** @class */ (function () {
                function SheieldingResponse() {
                }
                return SheieldingResponse;
            }());
            chat.SheieldingResponse = SheieldingResponse;
            var ReleaseShieldRequest = /** @class */ (function () {
                function ReleaseShieldRequest() {
                    this.userId = 0; // 玩家id
                }
                return ReleaseShieldRequest;
            }());
            chat.ReleaseShieldRequest = ReleaseShieldRequest;
            var ReleaseShieldResponse = /** @class */ (function () {
                function ReleaseShieldResponse() {
                }
                return ReleaseShieldResponse;
            }());
            chat.ReleaseShieldResponse = ReleaseShieldResponse;
            var recruitRequest = /** @class */ (function () {
                function recruitRequest() {
                }
                return recruitRequest;
            }());
            chat.recruitRequest = recruitRequest;
            var recruitResponse = /** @class */ (function () {
                function recruitResponse() {
                }
                return recruitResponse;
            }());
            chat.recruitResponse = recruitResponse;
        })(chat = API.chat || (API.chat = {}));
        var smallTarget;
        (function (smallTarget) {
            var LevGiftRequest = /** @class */ (function () {
                function LevGiftRequest() {
                }
                return LevGiftRequest;
            }());
            smallTarget.LevGiftRequest = LevGiftRequest;
            var LevGiftResponse = /** @class */ (function () {
                function LevGiftResponse() {
                    this.giftId = 0; // 礼包id
                }
                return LevGiftResponse;
            }());
            smallTarget.LevGiftResponse = LevGiftResponse;
            var CupGiftRequest = /** @class */ (function () {
                function CupGiftRequest() {
                }
                return CupGiftRequest;
            }());
            smallTarget.CupGiftRequest = CupGiftRequest;
            var CupGiftResponse = /** @class */ (function () {
                function CupGiftResponse() {
                    this.giftId = 0;
                }
                return CupGiftResponse;
            }());
            smallTarget.CupGiftResponse = CupGiftResponse;
            var GetCupMailRequest = /** @class */ (function () {
                function GetCupMailRequest() {
                }
                return GetCupMailRequest;
            }());
            smallTarget.GetCupMailRequest = GetCupMailRequest;
            var GetCupMailResponse = /** @class */ (function () {
                function GetCupMailResponse() {
                    this.giftId = 0;
                }
                return GetCupMailResponse;
            }());
            smallTarget.GetCupMailResponse = GetCupMailResponse;
        })(smallTarget = API.smallTarget || (API.smallTarget = {}));
        var account;
        (function (account) {
            var authRequest = /** @class */ (function () {
                function authRequest() {
        ...
        (function (ClientGM) {
            ...
            var gmPrintMemRequest = /** @class */ (function () {
                function gmPrintMemRequest() {
                }
                return gmPrintMemRequest;
            }());
            ClientGM.gmPrintMemRequest = gmPrintMemRequest;
            var gmPrintMemResponse = /** @class */ (function () {
                function gmPrintMemResponse() {
                }
                return gmPrintMemResponse;
            }());
            ClientGM.gmPrintMemResponse = gmPrintMemResponse;
            var gmTestLocalStorageSaveRequest = /** @class */ (function () {
                function gmTestLocalStorageSaveRequest() {
                }
                return gmTestLocalStorageSaveRequest;
            }());
            ClientGM.gmTestLocalStorageSaveRequest = gmTestLocalStorageSaveRequest;
            var gmTestLocalStorageSaveResponse = /** @class */ (function () {
                function gmTestLocalStorageSaveResponse() {
                }
                return gmTestLocalStorageSaveResponse;
            }());
            ClientGM.gmTestLocalStorageSaveResponse = gmTestLocalStorageSaveResponse;
            var gmTestLocalStorageReadRequest = /** @class */ (function () {
                function gmTestLocalStorageReadRequest() {
                }
                return gmTestLocalStorageReadRequest;
            }());
            ClientGM.gmTestLocalStorageReadRequest = gmTestLocalStorageReadRequest;
            var gmTestLocalStorageReadResponse = /** @class */ (function () {
                function gmTestLocalStorageReadResponse() {
                }
                return gmTestLocalStorageReadResponse;
            }());
            ClientGM.gmTestLocalStorageReadResponse = gmTestLocalStorageReadResponse;
            var gmTestTimerLoopRequest = /** @class */ (function () {
                function gmTestTimerLoopRequest() {
                }
                return gmTestTimerLoopRequest;
            }());
            ClientGM.gmTestTimerLoopRequest = gmTestTimerLoopRequest;
            var gmTestTimerLoopResponse = /** @class */ (function () {
                function gmTestTimerLoopResponse() {
                }
                return gmTestTimerLoopResponse;
            }());
            ClientGM.gmTestTimerLoopResponse = gmTestTimerLoopResponse;
            var gmTestReloginRequest = /** @class */ (function () {
                function gmTestReloginRequest() {
                }
                return gmTestReloginRequest;
            }());
            ClientGM.gmTestReloginRequest = gmTestReloginRequest;
            var gmTestReloginResponse = /** @class */ (function () {
                function gmTestReloginResponse() {
                }
                return gmTestReloginResponse;
            }());
            ClientGM.gmTestReloginResponse = gmTestReloginResponse;
            var gmTestRelogin2Request = /** @class */ (function () {
                function gmTestRelogin2Request() {
                }
                return gmTestRelogin2Request;
            }());
            ClientGM.gmTestRelogin2Request = gmTestRelogin2Request;
            var gmTestRelogin2Response = /** @class */ (function () {
                function gmTestRelogin2Response() {
                }
                return gmTestRelogin2Response;
            }());
            ClientGM.gmTestRelogin2Response = gmTestRelogin2Response;
            var gmTestPrintTotalActiveTweensRequest = /** @class */ (function () {
                function gmTestPrintTotalActiveTweensRequest() {
                }
                return gmTestPrintTotalActiveTweensRequest;
            }());
            ClientGM.gmTestPrintTotalActiveTweensRequest = gmTestPrintTotalActiveTweensRequest;
            var gmTestPrintTotalActiveTweensResponse = /** @class */ (function () {
                function gmTestPrintTotalActiveTweensResponse() {
                }
                return gmTestPrintTotalActiveTweensResponse;
            }());
            ClientGM.gmTestPrintTotalActiveTweensResponse = gmTestPrintTotalActiveTweensResponse;
            var gmTestKillAlphaTransitionRequest = /** @class */ (function () {
                function gmTestKillAlphaTransitionRequest() {
                }
                return gmTestKillAlphaTransitionRequest;
            }());
            ClientGM.gmTestKillAlphaTransitionRequest = gmTestKillAlphaTransitionRequest;
            var gmTestKillAlphaTransitionResponse = /** @class */ (function () {
                function gmTestKillAlphaTransitionResponse() {
                }
                return gmTestKillAlphaTransitionResponse;
            }());
            ClientGM.gmTestKillAlphaTransitionResponse = gmTestKillAlphaTransitionResponse;
            var gmPauseRequest = /** @class */ (function () {
                function gmPauseRequest() {
                }
                return gmPauseRequest;
            }());
            ClientGM.gmPauseRequest = gmPauseRequest;
            var gmPauseResponse = /** @class */ (function () {
                function gmPauseResponse() {
                }
                return gmPauseResponse;
            }());
            ClientGM.gmPauseResponse = gmPauseResponse;
            var gmPauseRebderRequest = /** @class */ (function () {
                function gmPauseRebderRequest() {
                }
                return gmPauseRebderRequest;
            }());
            ClientGM.gmPauseRebderRequest = gmPauseRebderRequest;
            var gmPauseRebderResponse = /** @class */ (function () {
                function gmPauseRebderResponse() {
                }
                return gmPauseRebderResponse;
            }());
            ClientGM.gmPauseRebderResponse = gmPauseRebderResponse;
            var gmCacheAsRequest = /** @class */ (function () {
                function gmCacheAsRequest() {
                }
                return gmCacheAsRequest;
            }());
            ClientGM.gmCacheAsRequest = gmCacheAsRequest;
            var gmCacheAsResponse = /** @class */ (function () {
                function gmCacheAsResponse() {
                }
                return gmCacheAsResponse;
            }());
            ClientGM.gmCacheAsResponse = gmCacheAsResponse;
            var gmStopAllTransformRequest = /** @class */ (function () {
                function gmStopAllTransformRequest() {
                }
                return gmStopAllTransformRequest;
            }());
            ClientGM.gmStopAllTransformRequest = gmStopAllTransformRequest;
            var gmStopAllTransformResponse = /** @class */ (function () {
                function gmStopAllTransformResponse() {
                }
                return gmStopAllTransformResponse;
            }());
            ClientGM.gmStopAllTransformResponse = gmStopAllTransformResponse;
            var gmEnablePrinLoopRequest = /** @class */ (function () {
                function gmEnablePrinLoopRequest() {
                }
                return gmEnablePrinLoopRequest;
            }());
            ClientGM.gmEnablePrinLoopRequest = gmEnablePrinLoopRequest;
            var gmEnablePrinLoopResponse = /** @class */ (function () {
                function gmEnablePrinLoopResponse() {
                }
                return gmEnablePrinLoopResponse;
            }());
            ClientGM.gmEnablePrinLoopResponse = gmEnablePrinLoopResponse;
