...
(function (Proto) {
    ...
    (function (SE) {
        ...
        (function (EItemCategory) {
            ...
            EItemCategory[EItemCategory["piecesgiftbag"] = 17] = "piecesgiftbag";
            EItemCategory[EItemCategory["story"] = 18] = "story";
        ...
        (function (EGlobalId) {
            ...
            EGlobalId[EGlobalId["firstActor"] = 9997] = "firstActor";
        ...
        (function (EManageProduce) {
            EManageProduce[EManageProduce["line"] = 1] = "line";
            EManageProduce[EManageProduce["save"] = 2] = "save";
            EManageProduce[EManageProduce["time"] = 3] = "time";
            EManageProduce[EManageProduce["output_initial"] = 4] = "output_initial";
        ...
        (function (EMailId) {
            ...
            EMailId[EMailId["cupPackage"] = 13] = "cupPackage";
        ...
        (function (EGMRefreshType) {
            ...
            EGMRefreshType[EGMRefreshType["sevenAddup"] = 5] = "sevenAddup";
            EGMRefreshType[EGMRefreshType["findStory"] = 6] = "findStory";
        ...
        var EItemType;
        (function (EItemType) {
            EItemType[EItemType["randomActor"] = 16] = "randomActor";
        })(EItemType = SE.EItemType || (SE.EItemType = {}));
        var EGuideType;
        (function (EGuideType) {
        ...
        var ECooperate;
        (function (ECooperate) {
            ECooperate[ECooperate["taskLength"] = 6] = "taskLength";
        })(ECooperate = SE.ECooperate || (SE.ECooperate = {}));
        var EChatChannel;
        (function (EChatChannel) {
            EChatChannel[EChatChannel["private"] = 1] = "private";
            EChatChannel[EChatChannel["world"] = 2] = "world";
            EChatChannel[EChatChannel["company"] = 3] = "company";
        })(EChatChannel = SE.EChatChannel || (SE.EChatChannel = {}));
        var ESystemMessageId;
        (function (ESystemMessageId) {
            ESystemMessageId[ESystemMessageId["getActor1"] = 1001] = "getActor1";
            ESystemMessageId[ESystemMessageId["getActor2"] = 1002] = "getActor2";
            ESystemMessageId[ESystemMessageId["movie"] = 1003] = "movie";
            ESystemMessageId[ESystemMessageId["updateName"] = 1004] = "updateName";
            ESystemMessageId[ESystemMessageId["createCompany"] = 1005] = "createCompany";
            ESystemMessageId[ESystemMessageId["joinCompany"] = 1006] = "joinCompany";
        })(ESystemMessageId = SE.ESystemMessageId || (SE.ESystemMessageId = {}));
        var ESystemType;
        (function (ESystemType) {
            ESystemType[ESystemType["userName"] = 1] = "userName";
            ESystemType[ESystemType["oldName"] = 2] = "oldName";
            ESystemType[ESystemType["actorStar"] = 3] = "actorStar";
            ESystemType[ESystemType["actorName"] = 4] = "actorName";
            ESystemType[ESystemType["moiveName"] = 5] = "moiveName";
            ESystemType[ESystemType["blockLevel"] = 6] = "blockLevel";
            ESystemType[ESystemType["boxOfficeEvaluation"] = 7] = "boxOfficeEvaluation";
            ESystemType[ESystemType["groupName"] = 8] = "groupName";
        })(ESystemType = SE.ESystemType || (SE.ESystemType = {}));
        var EGameDataOps;
        ...
        var ProtoVersion = /** @class */ (function () {
            ...
            ProtoVersion.versionCode = 10; //协议版本号数字表示
            ProtoVersion.versionName = "0.1.0"; //协议版本号字符表示
            return ProtoVersion;
        }());
        ...
        var DBOType = /** @class */ (function () {
            ...
            DBOType.LevelGiftData = "LevelGiftData";
            DBOType.GetGuideReward = "GetGuideReward"; // 完成所有引导任务领取奖励
            DBOType.CupPackage = "CupPackage"; // 奖杯礼包
            DBOType.StoryRefreshData = "StoryRefreshData"; // 剧本刷新时间信息
            return DBOType;
        }());
        SE.DBOType = DBOType;
